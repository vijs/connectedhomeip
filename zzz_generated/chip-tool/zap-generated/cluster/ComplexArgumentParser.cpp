...
CHIP_ERROR
ComplexArgumentParser::Setup(const char * label,
                             chip::app::Clusters::ClosureDimension::Structs::ClosureDimensionTargetStruct::Type & request,
                             Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::ClosureDimension::Structs::ClosureDimensionTargetStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.position);
    ComplexArgumentParser::Finalize(request.latch);
    ComplexArgumentParser::Finalize(request.speed);
...
CHIP_ERROR
ComplexArgumentParser::Setup(const char * label,
                             chip::app::Clusters::JointFabricDatastore::Structs::DatastoreNodeKeyEntryStruct::Type & request,
                             Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreNodeKeyEntryStruct.nodeID", "nodeID", value.isMember("nodeID")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreNodeKeyEntryStruct.groupKeySetId", "groupKeySetId",
                                                                  value.isMember("groupKeySetId")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreNodeKeyEntryStruct.statusEntry", "statusEntry",

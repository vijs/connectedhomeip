    ...
    const chip::app::Clusters::JointFabricAdministrator::Commands::AddICAC::DecodableType & commandData)
{
    ...
    auto & jfDatastorage             = Server::GetInstance().GetJointFabricDatastorage();
...

    {
        ...
        err = fabricTable.FetchNOCCert(jfDatastorage.GetAdministratorFabricIndex(), administratorNocChipSpan);

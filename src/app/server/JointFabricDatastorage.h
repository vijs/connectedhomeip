...
public:
    ...
    CHIP_ERROR AddGroupKeySetEntry(Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type & groupKeySet);
    bool IsGroupKeySetEntryPresent(uint16_t groupKeySetId);
    CHIP_ERROR RemoveGroupKeySetEntry(uint16_t groupKeySetId);
    CHIP_ERROR UpdateGroupKeySetEntry(Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type & groupKeySet);
    ...
    const std::vector<Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type> & GetGroupKeySetList()
    {
...
private:
    ...
    std::vector<Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type> mGroupKeySetList;

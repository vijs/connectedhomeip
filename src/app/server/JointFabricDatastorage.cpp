...
CHIP_ERROR JointFabricDatastorage::AddGroupKeySetEntry(uint16_t groupKeySetId)
{
    ...
    Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type entry;
...
CHIP_ERROR
JointFabricDatastorage::AddGroupKeySetEntry(Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type & groupKeySet)
{
...
CHIP_ERROR
JointFabricDatastorage::UpdateGroupKeySetEntry(Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type & groupKeySet)
{
    for (auto & entry : mGroupKeySetList)
    {
        ...
        {
            bool field_updated =
                memcmp(&entry, &groupKeySet, sizeof(Clusters::JointFabricDatastore::Structs::GroupKeySetStruct::Type)) == 0;
            entry = groupKeySet;

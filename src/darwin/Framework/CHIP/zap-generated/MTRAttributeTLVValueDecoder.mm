            ...
            while (iter_0.Next()) {
                ...
                { // Scope for our temporary variables
                    ...
                    while (iter_2.Next()) {
                        ...
                        newElement_2.aclEntry = [MTRJointFabricDatastoreClusterAccessControlEntryStruct new];
                        newElement_2.aclEntry.privilege = [NSNumber numberWithUnsignedChar:chip::to_underlying(entry_2.ACLEntry.privilege)];
                        newElement_2.aclEntry.authMode = [NSNumber numberWithUnsignedChar:chip::to_underlying(entry_2.ACLEntry.authMode)];
                        if (entry_2.ACLEntry.subjects.IsNull()) {
                            newElement_2.aclEntry.subjects = nil;
                        } else {
                            { // Scope for our temporary variables
                                auto * array_6 = [NSMutableArray new];
                                auto iter_6 = entry_2.ACLEntry.subjects.Value().begin();
                                while (iter_6.Next()) {
                                    auto & entry_6 = iter_6.GetValue();
                                    NSNumber * newElement_6;
                                    newElement_6 = [NSNumber numberWithUnsignedLongLong:entry_6];
                                ...
                                newElement_2.aclEntry.subjects = array_6;
                            }
                        }
                        if (entry_2.ACLEntry.targets.IsNull()) {
                            newElement_2.aclEntry.targets = nil;
                        } else {
                            { // Scope for our temporary variables
                                auto * array_6 = [NSMutableArray new];
                                auto iter_6 = entry_2.ACLEntry.targets.Value().begin();
                                while (iter_6.Next()) {
                                    auto & entry_6 = iter_6.GetValue();
                                    MTRJointFabricDatastoreClusterAccessControlTargetStruct * newElement_6;
                                    newElement_6 = [MTRJointFabricDatastoreClusterAccessControlTargetStruct new];
                                    if (entry_6.cluster.IsNull()) {
                                        newElement_6.cluster = nil;
                                    } else {
                                        newElement_6.cluster = [NSNumber numberWithUnsignedInt:entry_6.cluster.Value()];
                                    }
                                    if (entry_6.endpoint.IsNull()) {
                                        newElement_6.endpoint = nil;
                                    } else {
                                        newElement_6.endpoint = [NSNumber numberWithUnsignedShort:entry_6.endpoint.Value()];
                                    }
                                    if (entry_6.deviceType.IsNull()) {
                                        newElement_6.deviceType = nil;
                                    } else {
                                        newElement_6.deviceType = [NSNumber numberWithUnsignedInt:entry_6.deviceType.Value()];
                                    }
                                    [array_6 addObject:newElement_6];
                                }
                                CHIP_ERROR err = iter_6.GetStatus();
                                ...
                                newElement_2.aclEntry.targets = array_6;
                            }
                        }
                        newElement_2.statusEntry = [MTRJointFabricDatastoreClusterDatastoreStatusEntry new];
                        newElement_2.statusEntry.state = [NSNumber numberWithUnsignedChar:chip::to_underlying(entry_2.statusEntry.state)];
                    ...
                    while (iter_2.Next()) {
                        ...
                        { // Scope for our temporary variables
                            ...
                            while (iter_4.Next()) {
                                ...
                                newElement_4.binding = [MTRJointFabricDatastoreClusterTargetStruct new];
                                if (entry_4.binding.node.HasValue()) {
                                    newElement_4.binding.node = [NSNumber numberWithUnsignedLongLong:entry_4.binding.node.Value()];
                                } else {
                                    newElement_4.binding.node = nil;
                                }
                                if (entry_4.binding.group.HasValue()) {
                                    newElement_4.binding.group = [NSNumber numberWithUnsignedShort:entry_4.binding.group.Value()];
                                } else {
                                    newElement_4.binding.group = nil;
                                }
                                if (entry_4.binding.endpoint.HasValue()) {
                                    newElement_4.binding.endpoint = [NSNumber numberWithUnsignedShort:entry_4.binding.endpoint.Value()];
                                } else {
                                    newElement_4.binding.endpoint = nil;
                                }
                                if (entry_4.binding.cluster.HasValue()) {
                                    newElement_4.binding.cluster = [NSNumber numberWithUnsignedInt:entry_4.binding.cluster.Value()];
                                } else {
                                    newElement_4.binding.cluster = nil;
                                }
                                newElement_4.statusEntry = [MTRJointFabricDatastoreClusterDatastoreStatusEntry new];
                                newElement_4.statusEntry.state = [NSNumber numberWithUnsignedChar:chip::to_underlying(entry_4.statusEntry.state)];
                                if (entry_4.statusEntry.updateTimestamp.IsNull()) {

...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: listID:%@; binding:%@; statusEntry:%@; >", NSStringFromClass([self class]), _listID, _binding, _statusEntry];
    return descriptionString;
}
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: listID:%@; aclEntry:%@; statusEntry:%@; >", NSStringFromClass([self class]), _listID, _aclEntry, _statusEntry];
    return descriptionString;
}

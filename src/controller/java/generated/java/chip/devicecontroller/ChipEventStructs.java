...
public class ChipEventStructs {
  public static class AccessControlClusterAccessControlEntryChangedEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ADMIN_NODE_I_D_ID, adminNodeID != null ? new UIntType(adminNodeID) : new NullType()));
      values.add(
          new StructElement(
              ADMIN_PASSCODE_I_D_ID,
              adminPasscodeID != null ? new UIntType(adminPasscodeID) : new NullType()));
      values.add(new StructElement(CHANGE_TYPE_ID, new UIntType(changeType)));
      values.add(
          new StructElement(
              LATEST_VALUE_ID, latestValue != null ? latestValue.encodeTlv() : new NullType()));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));

      return new StructType(values);
    }

    public static AccessControlClusterAccessControlEntryChangedEvent decodeTlv(
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ADMIN_NODE_I_D_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            latestValue =
                ChipStructs.AccessControlClusterAccessControlEntryStruct.decodeTlv(castingValue);
          }
      ...
      return new AccessControlClusterAccessControlEntryChangedEvent(
          adminNodeID, adminPasscodeID, changeType, latestValue, fabricIndex);
    }
  ...
  public static class AccessControlClusterAccessControlExtensionChangedEvent {
    ...
    public static AccessControlClusterAccessControlExtensionChangedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ADMIN_NODE_I_D_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            latestValue =
                ChipStructs.AccessControlClusterAccessControlExtensionStruct.decodeTlv(
                    castingValue);
          }
        } else if (element.contextTagNum() == FABRIC_INDEX_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.UInt) {
  ...
  public static class ActionsClusterStateChangedEvent {
    ...
    public static ActionsClusterStateChangedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ActionsClusterStateChangedEvent(actionID, invokeID, newState);
    }
  ...
  public static class ActionsClusterActionFailedEvent {
    ...
    public static ActionsClusterActionFailedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ActionsClusterActionFailedEvent(actionID, invokeID, newState, error);
    }
  ...
  public static class BasicInformationClusterStartUpEvent {
    ...
    public static BasicInformationClusterStartUpEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BasicInformationClusterStartUpEvent(softwareVersion);
    }
  ...
  public static class BasicInformationClusterLeaveEvent {
    ...
    public static BasicInformationClusterLeaveEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BasicInformationClusterLeaveEvent(fabricIndex);
    }
  ...
  public static class BasicInformationClusterReachableChangedEvent {
    ...
    public static BasicInformationClusterReachableChangedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BasicInformationClusterReachableChangedEvent(reachableNewValue);
    }
  ...
  public static class OtaSoftwareUpdateRequestorClusterStateTransitionEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TARGET_SOFTWARE_VERSION_ID,
              targetSoftwareVersion != null
                  ? new UIntType(targetSoftwareVersion)
                  : new NullType()));

      return new StructType(values);
    }

    public static OtaSoftwareUpdateRequestorClusterStateTransitionEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class OtaSoftwareUpdateRequestorClusterVersionAppliedEvent {
    ...
    public static OtaSoftwareUpdateRequestorClusterVersionAppliedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new OtaSoftwareUpdateRequestorClusterVersionAppliedEvent(softwareVersion, productID);
    }
  ...
  public static class OtaSoftwareUpdateRequestorClusterDownloadErrorEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              PROGRESS_PERCENT_ID,
              progressPercent != null ? new UIntType(progressPercent) : new NullType()));
      values.add(
          new StructElement(
              PLATFORM_CODE_ID, platformCode != null ? new IntType(platformCode) : new NullType()));

      return new StructType(values);
    }

    public static OtaSoftwareUpdateRequestorClusterDownloadErrorEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PowerSourceClusterWiredFaultChangeEvent {
    ...
    public static PowerSourceClusterWiredFaultChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new PowerSourceClusterWiredFaultChangeEvent(current, previous);
    }
  ...
  public static class PowerSourceClusterBatFaultChangeEvent {
    ...
    public static PowerSourceClusterBatFaultChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new PowerSourceClusterBatFaultChangeEvent(current, previous);
    }
  ...
  public static class PowerSourceClusterBatChargeFaultChangeEvent {
    ...
    public static PowerSourceClusterBatChargeFaultChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new PowerSourceClusterBatChargeFaultChangeEvent(current, previous);
    }
  ...
  public static class GeneralDiagnosticsClusterHardwareFaultChangeEvent {
    ...
    public static GeneralDiagnosticsClusterHardwareFaultChangeEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new GeneralDiagnosticsClusterHardwareFaultChangeEvent(current, previous);
    }
  ...
  public static class GeneralDiagnosticsClusterRadioFaultChangeEvent {
    ...
    public static GeneralDiagnosticsClusterRadioFaultChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new GeneralDiagnosticsClusterRadioFaultChangeEvent(current, previous);
    }
  ...
  public static class GeneralDiagnosticsClusterNetworkFaultChangeEvent {
    ...
    public static GeneralDiagnosticsClusterNetworkFaultChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new GeneralDiagnosticsClusterNetworkFaultChangeEvent(current, previous);
    }
  ...
  public static class GeneralDiagnosticsClusterBootReasonEvent {
    ...
    public static GeneralDiagnosticsClusterBootReasonEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new GeneralDiagnosticsClusterBootReasonEvent(bootReason);
    }
  ...
  public static class SoftwareDiagnosticsClusterSoftwareFaultEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              faultRecording
                  .<BaseTLVType>map(
                      (nonOptionalfaultRecording) -> new ByteArrayType(nonOptionalfaultRecording))
                  .orElse(new EmptyType())));
    ...
    public static SoftwareDiagnosticsClusterSoftwareFaultEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SoftwareDiagnosticsClusterSoftwareFaultEvent(id, name, faultRecording);
    }
  ...
  public static class ThreadNetworkDiagnosticsClusterConnectionStatusEvent {
    ...
    public static ThreadNetworkDiagnosticsClusterConnectionStatusEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new ThreadNetworkDiagnosticsClusterConnectionStatusEvent(connectionStatus);
    }
  ...
  public static class ThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent {
    ...
    public static ThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new ThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent(current, previous);
    }
  ...
  public static class WiFiNetworkDiagnosticsClusterDisconnectionEvent {
    ...
    public static WiFiNetworkDiagnosticsClusterDisconnectionEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new WiFiNetworkDiagnosticsClusterDisconnectionEvent(reasonCode);
    }
  ...
  public static class WiFiNetworkDiagnosticsClusterAssociationFailureEvent {
    ...
    public WiFiNetworkDiagnosticsClusterAssociationFailureEvent(
        Integer associationFailureCause, Integer status) {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(ASSOCIATION_FAILURE_CAUSE_ID, new UIntType(associationFailureCause)));
      values.add(new StructElement(STATUS_ID, new UIntType(status)));

      return new StructType(values);
    }

    public static WiFiNetworkDiagnosticsClusterAssociationFailureEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class WiFiNetworkDiagnosticsClusterConnectionStatusEvent {
    ...
    public static WiFiNetworkDiagnosticsClusterConnectionStatusEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new WiFiNetworkDiagnosticsClusterConnectionStatusEvent(connectionStatus);
    }
  ...
  public static class TimeSynchronizationClusterDSTStatusEvent {
    ...
    public static TimeSynchronizationClusterDSTStatusEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new TimeSynchronizationClusterDSTStatusEvent(DSTOffsetActive);
    }
  ...
  public static class TimeSynchronizationClusterTimeZoneStatusEvent {
    ...
    public static TimeSynchronizationClusterTimeZoneStatusEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new TimeSynchronizationClusterTimeZoneStatusEvent(offset, name);
    }
  ...
  public static class TimeSynchronizationClusterMissingTrustedTimeSourceEvent {
    ...
    public static TimeSynchronizationClusterMissingTrustedTimeSourceEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class BridgedDeviceBasicInformationClusterStartUpEvent {
    ...
    public static BridgedDeviceBasicInformationClusterStartUpEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BridgedDeviceBasicInformationClusterStartUpEvent(softwareVersion);
    }
  ...
  public static class BridgedDeviceBasicInformationClusterShutDownEvent {
    ...
    public static BridgedDeviceBasicInformationClusterShutDownEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class BridgedDeviceBasicInformationClusterReachableChangedEvent {
    ...
    public static BridgedDeviceBasicInformationClusterReachableChangedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new BridgedDeviceBasicInformationClusterReachableChangedEvent(reachableNewValue);
    }
  ...
  public static class BridgedDeviceBasicInformationClusterActiveChangedEvent {
    ...
    public BridgedDeviceBasicInformationClusterActiveChangedEvent(Long promisedActiveDuration) {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(PROMISED_ACTIVE_DURATION_ID, new UIntType(promisedActiveDuration)));

      return new StructType(values);
    }

    public static BridgedDeviceBasicInformationClusterActiveChangedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new BridgedDeviceBasicInformationClusterActiveChangedEvent(promisedActiveDuration);
    }
  ...
  public static class SwitchClusterSwitchLatchedEvent {
    ...
    public static SwitchClusterSwitchLatchedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SwitchClusterSwitchLatchedEvent(newPosition);
    }
  ...
  public static class SwitchClusterInitialPressEvent {
    ...
    public static SwitchClusterInitialPressEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SwitchClusterInitialPressEvent(newPosition);
    }
  ...
  public static class SwitchClusterLongPressEvent {
    ...
    public static SwitchClusterLongPressEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SwitchClusterLongPressEvent(newPosition);
    }
  ...
  public static class SwitchClusterShortReleaseEvent {
    ...
    public static SwitchClusterShortReleaseEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SwitchClusterShortReleaseEvent(previousPosition);
    }
  ...
  public static class SwitchClusterLongReleaseEvent {
    ...
    public static SwitchClusterLongReleaseEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SwitchClusterLongReleaseEvent(previousPosition);
    }
  ...
  public static class SwitchClusterMultiPressOngoingEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              CURRENT_NUMBER_OF_PRESSES_COUNTED_ID, new UIntType(currentNumberOfPressesCounted)));
    ...
    public static SwitchClusterMultiPressOngoingEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SwitchClusterMultiPressOngoingEvent(newPosition, currentNumberOfPressesCounted);
    }
  ...
  public static class SwitchClusterMultiPressCompleteEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TOTAL_NUMBER_OF_PRESSES_COUNTED_ID, new UIntType(totalNumberOfPressesCounted)));
  ...
  public static class BooleanStateClusterStateChangeEvent {
    ...
    public static BooleanStateClusterStateChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BooleanStateClusterStateChangeEvent(stateValue);
    }
  ...
  public static class OvenCavityOperationalStateClusterOperationalErrorEvent {
    ...
    public static OvenCavityOperationalStateClusterOperationalErrorEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ERROR_STATE_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            errorState =
                ChipStructs.OvenCavityOperationalStateClusterErrorStateStruct.decodeTlv(
                    castingValue);
          }
        }
      }
      return new OvenCavityOperationalStateClusterOperationalErrorEvent(errorState);
    }
  ...
  public static class OvenCavityOperationalStateClusterOperationCompletionEvent {
      ...
      values.add(
          new StructElement(
              ...
              pausedTime != null
                  ? pausedTime
                      .<BaseTLVType>map(
                          (nonOptionalpausedTime) -> new UIntType(nonOptionalpausedTime))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static OvenCavityOperationalStateClusterOperationCompletionEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class RefrigeratorAlarmClusterNotifyEvent {
    ...
    public static RefrigeratorAlarmClusterNotifyEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new RefrigeratorAlarmClusterNotifyEvent(active, inactive, state, mask);
    }
  ...
  public static class SmokeCoAlarmClusterSmokeAlarmEvent {
    ...
    public SmokeCoAlarmClusterSmokeAlarmEvent(Integer alarmSeverityLevel) {
    ...
    public static SmokeCoAlarmClusterSmokeAlarmEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SmokeCoAlarmClusterSmokeAlarmEvent(alarmSeverityLevel);
    }
  ...
  public static class SmokeCoAlarmClusterCOAlarmEvent {
    ...
    public SmokeCoAlarmClusterCOAlarmEvent(Integer alarmSeverityLevel) {
      this.alarmSeverityLevel = alarmSeverityLevel;
    }
    ...
    public static SmokeCoAlarmClusterCOAlarmEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SmokeCoAlarmClusterCOAlarmEvent(alarmSeverityLevel);
    }
  ...
  public static class SmokeCoAlarmClusterLowBatteryEvent {
    ...
    public SmokeCoAlarmClusterLowBatteryEvent(Integer alarmSeverityLevel) {
      this.alarmSeverityLevel = alarmSeverityLevel;
    }
    ...
    public static SmokeCoAlarmClusterLowBatteryEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SmokeCoAlarmClusterLowBatteryEvent(alarmSeverityLevel);
    }
  ...
  public static class SmokeCoAlarmClusterInterconnectSmokeAlarmEvent {
    ...
    public SmokeCoAlarmClusterInterconnectSmokeAlarmEvent(Integer alarmSeverityLevel) {
      this.alarmSeverityLevel = alarmSeverityLevel;
    }
    ...
    public static SmokeCoAlarmClusterInterconnectSmokeAlarmEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SmokeCoAlarmClusterInterconnectSmokeAlarmEvent(alarmSeverityLevel);
    }
  ...
  public static class SmokeCoAlarmClusterInterconnectCOAlarmEvent {
    ...
    public SmokeCoAlarmClusterInterconnectCOAlarmEvent(Integer alarmSeverityLevel) {
      this.alarmSeverityLevel = alarmSeverityLevel;
    }
    ...
    public static SmokeCoAlarmClusterInterconnectCOAlarmEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SmokeCoAlarmClusterInterconnectCOAlarmEvent(alarmSeverityLevel);
    }
  ...
  public static class DishwasherAlarmClusterNotifyEvent {
    ...
    public static DishwasherAlarmClusterNotifyEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DishwasherAlarmClusterNotifyEvent(active, inactive, state, mask);
    }
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ERROR_STATE_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            errorState =
                ChipStructs.OperationalStateClusterErrorStateStruct.decodeTlv(castingValue);
          }
        }
      }
      return new OperationalStateClusterOperationalErrorEvent(errorState);
    }
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ERROR_STATE_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            errorState =
                ChipStructs.RvcOperationalStateClusterErrorStateStruct.decodeTlv(castingValue);
          }
        }
      }
      return new RvcOperationalStateClusterOperationalErrorEvent(errorState);
    }
  ...
  public static class RvcOperationalStateClusterOperationCompletionEvent {
    ...
    public static RvcOperationalStateClusterOperationCompletionEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class BooleanStateConfigurationClusterAlarmsStateChangedEvent {
    ...
    public BooleanStateConfigurationClusterAlarmsStateChangedEvent(
        Integer alarmsActive, Optional<Integer> alarmsSuppressed) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ALARMS_SUPPRESSED_ID,
              alarmsSuppressed
                  .<BaseTLVType>map(
                      (nonOptionalalarmsSuppressed) -> new UIntType(nonOptionalalarmsSuppressed))
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static BooleanStateConfigurationClusterAlarmsStateChangedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class BooleanStateConfigurationClusterSensorFaultEvent {
    ...
    public BooleanStateConfigurationClusterSensorFaultEvent(Integer sensorFault) {
  ...
  public static class ValveConfigurationAndControlClusterValveStateChangedEvent {
    ...
    public ValveConfigurationAndControlClusterValveStateChangedEvent(
        Integer valveState, Optional<Integer> valveLevel) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              VALVE_LEVEL_ID,
              valveLevel
                  .<BaseTLVType>map((nonOptionalvalveLevel) -> new UIntType(nonOptionalvalveLevel))
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static ValveConfigurationAndControlClusterValveStateChangedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new ValveConfigurationAndControlClusterValveStateChangedEvent(valveState, valveLevel);
    }
  ...
  public static class ValveConfigurationAndControlClusterValveFaultEvent {
    ...
    public ValveConfigurationAndControlClusterValveFaultEvent(Integer valveFault) {
    ...
    public static ValveConfigurationAndControlClusterValveFaultEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new ValveConfigurationAndControlClusterValveFaultEvent(valveFault);
    }
  ...
  public static class ElectricalPowerMeasurementClusterMeasurementPeriodRangesEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              RANGES_ID,
              ArrayType.generateArrayType(ranges, (elementranges) -> elementranges.encodeTlv())));

      return new StructType(values);
    }

    public static ElectricalPowerMeasurementClusterMeasurementPeriodRangesEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
        ...
        if (element.contextTagNum() == RANGES_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            ranges =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.ElectricalPowerMeasurementClusterMeasurementRangeStruct
                            .decodeTlv(elementcastingValue));
          }
        }
      }
      return new ElectricalPowerMeasurementClusterMeasurementPeriodRangesEvent(ranges);
    }
  ...
  public static class ElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent {
    public Optional<ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct>
        energyImported;
    public Optional<ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct>
        energyExported;
    ...
    public ElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent(
        Optional<ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct>
            energyImported,
        Optional<ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct>
            energyExported) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              energyImported
                  .<BaseTLVType>map(
                      (nonOptionalenergyImported) -> nonOptionalenergyImported.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              ENERGY_EXPORTED_ID,
              energyExported
                  .<BaseTLVType>map(
                      (nonOptionalenergyExported) -> nonOptionalenergyExported.encodeTlv())
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static ElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      Optional<ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct>
          energyImported = Optional.empty();
      Optional<ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct>
          energyExported = Optional.empty();
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ENERGY_IMPORTED_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            energyImported =
                Optional.of(
                    ChipStructs.ElectricalEnergyMeasurementClusterEnergyMeasurementStruct.decodeTlv(
                        castingValue));
          }
  ...
  public static class ElectricalEnergyMeasurementClusterPeriodicEnergyMeasuredEvent {
    ...
    public static ElectricalEnergyMeasurementClusterPeriodicEnergyMeasuredEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent {
    ...
    public @Nullable Optional<ChipStructs.DemandResponseLoadControlClusterTemperatureControlStruct>
        temperatureControl;
    public @Nullable Optional<ChipStructs.DemandResponseLoadControlClusterAverageLoadControlStruct>
        averageLoadControl;
    public @Nullable Optional<ChipStructs.DemandResponseLoadControlClusterDutyCycleControlStruct>
        dutyCycleControl;
    public @Nullable Optional<ChipStructs.DemandResponseLoadControlClusterPowerSavingsControlStruct>
        powerSavingsControl;
    public @Nullable Optional<
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TRANSITION_INDEX_ID,
              transitionIndex != null ? new UIntType(transitionIndex) : new NullType()));
      values.add(new StructElement(STATUS_ID, new UIntType(status)));
      ...
      values.add(
          new StructElement(
              ...
              temperatureControl != null
                  ? temperatureControl
                      .<BaseTLVType>map(
                          (nonOptionaltemperatureControl) ->
                              nonOptionaltemperatureControl.encodeTlv())
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              AVERAGE_LOAD_CONTROL_ID,
              averageLoadControl != null
                  ? averageLoadControl
                      .<BaseTLVType>map(
                          (nonOptionalaverageLoadControl) ->
                              nonOptionalaverageLoadControl.encodeTlv())
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              DUTY_CYCLE_CONTROL_ID,
              dutyCycleControl != null
                  ? dutyCycleControl
                      .<BaseTLVType>map(
    ...
    public static DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class MessagesClusterMessageQueuedEvent {
    ...
    public MessagesClusterMessageQueuedEvent(byte[] messageID) {
    ...
    public static MessagesClusterMessageQueuedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MessagesClusterMessageQueuedEvent(messageID);
    }
  ...
  public static class MessagesClusterMessagePresentedEvent {
    ...
    public MessagesClusterMessagePresentedEvent(byte[] messageID) {
      this.messageID = messageID;
    }
    ...
    public static MessagesClusterMessagePresentedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MessagesClusterMessagePresentedEvent(messageID);
    }
  ...
  public static class MessagesClusterMessageCompleteEvent {
      ...
      values.add(
          new StructElement(
              ...
              responseID != null
                  ? responseID
                      .<BaseTLVType>map(
                          (nonOptionalresponseID) -> new UIntType(nonOptionalresponseID))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              reply != null
                  ? reply
                      .<BaseTLVType>map((nonOptionalreply) -> new StringType(nonOptionalreply))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              FUTURE_MESSAGES_PREFERENCE_ID,
              futureMessagesPreference != null
                  ? new UIntType(futureMessagesPreference)
                  : new NullType()));
    ...
    public static MessagesClusterMessageCompleteEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MessagesClusterMessageCompleteEvent(
          messageID, responseID, reply, futureMessagesPreference);
    }
  ...
  public static class DeviceEnergyManagementClusterPowerAdjustStartEvent {
    ...
    public static DeviceEnergyManagementClusterPowerAdjustStartEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class DeviceEnergyManagementClusterPowerAdjustEndEvent {
    ...
    public DeviceEnergyManagementClusterPowerAdjustEndEvent(
        Integer cause, Long duration, Long energyUse) {
      this.cause = cause;
    ...
    public static DeviceEnergyManagementClusterPowerAdjustEndEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DeviceEnergyManagementClusterPowerAdjustEndEvent(cause, duration, energyUse);
    }
  ...
  public static class DeviceEnergyManagementClusterResumedEvent {
    ...
    public DeviceEnergyManagementClusterResumedEvent(Integer cause) {
      this.cause = cause;
    }
    ...
    public static DeviceEnergyManagementClusterResumedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DeviceEnergyManagementClusterResumedEvent(cause);
    }
  ...
  public static class EnergyEvseClusterEVConnectedEvent {
    ...
    public EnergyEvseClusterEVConnectedEvent(Long sessionID) {
    ...
    public static EnergyEvseClusterEVConnectedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyEvseClusterEVConnectedEvent(sessionID);
    }
  ...
  public static class EnergyEvseClusterEVNotDetectedEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              SESSION_ENERGY_DISCHARGED_ID,
              sessionEnergyDischarged
                  .<BaseTLVType>map(
                      (nonOptionalsessionEnergyDischarged) ->
                          new IntType(nonOptionalsessionEnergyDischarged))
                  .orElse(new EmptyType())));
  ...
  public static class EnergyEvseClusterEnergyTransferStartedEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              MAXIMUM_DISCHARGE_CURRENT_ID,
              maximumDischargeCurrent
                  .<BaseTLVType>map(
                      (nonOptionalmaximumDischargeCurrent) ->
                          new IntType(nonOptionalmaximumDischargeCurrent))
                  .orElse(new EmptyType())));
    ...
    public static EnergyEvseClusterEnergyTransferStartedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyEvseClusterEnergyTransferStartedEvent(
          sessionID, state, maximumCurrent, maximumDischargeCurrent);
    }
  ...
  public static class EnergyEvseClusterEnergyTransferStoppedEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ENERGY_DISCHARGED_ID,
              energyDischarged
                  .<BaseTLVType>map(
                      (nonOptionalenergyDischarged) -> new IntType(nonOptionalenergyDischarged))
                  .orElse(new EmptyType())));
    ...
    public static EnergyEvseClusterEnergyTransferStoppedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyEvseClusterEnergyTransferStoppedEvent(
          sessionID, state, reason, energyTransferred, energyDischarged);
    }
  ...
  public static class EnergyEvseClusterFaultEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              SESSION_I_D_ID, sessionID != null ? new UIntType(sessionID) : new NullType()));
      values.add(new StructElement(STATE_ID, new UIntType(state)));
      values.add(
          new StructElement(FAULT_STATE_PREVIOUS_STATE_ID, new UIntType(faultStatePreviousState)));
      values.add(
          new StructElement(FAULT_STATE_CURRENT_STATE_ID, new UIntType(faultStateCurrentState)));
  ...
  public static class EnergyEvseClusterRFIDEvent {
    ...
    public EnergyEvseClusterRFIDEvent(byte[] uid) {
      this.uid = uid;
    }
    ...
    public static EnergyEvseClusterRFIDEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyEvseClusterRFIDEvent(uid);
    }
  ...
  public static class DoorLockClusterDoorLockAlarmEvent {
    ...
    public static DoorLockClusterDoorLockAlarmEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DoorLockClusterDoorLockAlarmEvent(alarmCode);
    }
  ...
  public static class DoorLockClusterDoorStateChangeEvent {
    ...
    public static DoorLockClusterDoorStateChangeEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DoorLockClusterDoorStateChangeEvent(doorState);
    }
  ...
  public static class DoorLockClusterLockOperationEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              USER_INDEX_ID, userIndex != null ? new UIntType(userIndex) : new NullType()));
      values.add(
          new StructElement(
              FABRIC_INDEX_ID, fabricIndex != null ? new UIntType(fabricIndex) : new NullType()));
      values.add(
          new StructElement(
              SOURCE_NODE_ID, sourceNode != null ? new UIntType(sourceNode) : new NullType()));
      values.add(
          new StructElement(
              CREDENTIALS_ID,
              credentials != null
                  ? credentials
                      .<BaseTLVType>map(
                          (nonOptionalcredentials) ->
                              ArrayType.generateArrayType(
                                  nonOptionalcredentials,
                                  (elementnonOptionalcredentials) ->
                                      elementnonOptionalcredentials.encodeTlv()))
                      .orElse(new EmptyType())
                  : new NullType()));
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            credentials =
                Optional.of(
                    castingValue.map(
                        (elementcastingValue) ->
                            ChipStructs.DoorLockClusterCredentialStruct.decodeTlv(
                                elementcastingValue)));
          }
        }
      }
  ...
  public static class DoorLockClusterLockUserChangeEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              DATA_INDEX_ID, dataIndex != null ? new UIntType(dataIndex) : new NullType()));
  ...
  public static class PumpConfigurationAndControlClusterSupplyVoltageLowEvent {
    ...
    public static PumpConfigurationAndControlClusterSupplyVoltageLowEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterSupplyVoltageHighEvent {
    ...
    public static PumpConfigurationAndControlClusterSupplyVoltageHighEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterPowerMissingPhaseEvent {
    ...
    public static PumpConfigurationAndControlClusterPowerMissingPhaseEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterSystemPressureLowEvent {
    ...
    public static PumpConfigurationAndControlClusterSystemPressureLowEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterSystemPressureHighEvent {
    ...
    public static PumpConfigurationAndControlClusterSystemPressureHighEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterDryRunningEvent {
    ...
    public static PumpConfigurationAndControlClusterDryRunningEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterMotorTemperatureHighEvent {
    ...
    public static PumpConfigurationAndControlClusterMotorTemperatureHighEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterPumpMotorFatalFailureEvent {
    ...
    public static PumpConfigurationAndControlClusterPumpMotorFatalFailureEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterElectronicTemperatureHighEvent {
    ...
    public static PumpConfigurationAndControlClusterElectronicTemperatureHighEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterPumpBlockedEvent {
    ...
    public static PumpConfigurationAndControlClusterPumpBlockedEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterSensorFailureEvent {
    ...
    public static PumpConfigurationAndControlClusterSensorFailureEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterElectronicNonFatalFailureEvent {
    ...
    public static PumpConfigurationAndControlClusterElectronicNonFatalFailureEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterElectronicFatalFailureEvent {
    ...
    public static PumpConfigurationAndControlClusterElectronicFatalFailureEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterGeneralFaultEvent {
    ...
    public static PumpConfigurationAndControlClusterGeneralFaultEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterAirDetectionEvent {
    ...
    public static PumpConfigurationAndControlClusterAirDetectionEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class PumpConfigurationAndControlClusterTurbineOperationEvent {
    ...
    public static PumpConfigurationAndControlClusterTurbineOperationEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class TargetNavigatorClusterTargetUpdatedEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TARGET_LIST_ID,
              ArrayType.generateArrayType(
                  targetList, (elementtargetList) -> elementtargetList.encodeTlv())));
    ...
    public static TargetNavigatorClusterTargetUpdatedEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new TargetNavigatorClusterTargetUpdatedEvent(targetList, currentTarget, data);
    }
  ...
  public static class MediaPlaybackClusterStateChangedEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              DATA_ID,
              data.<BaseTLVType>map((nonOptionaldata) -> new ByteArrayType(nonOptionaldata))
                  .orElse(new EmptyType())));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == CURRENT_STATE_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            sampledPosition =
                ChipStructs.MediaPlaybackClusterPlaybackPositionStruct.decodeTlv(castingValue);
          }
  ...
  public static class AccountLoginClusterLoggedOutEvent {
    ...
    public AccountLoginClusterLoggedOutEvent(Optional<Long> node) {
      this.node = node;
    }
    ...
    public static AccountLoginClusterLoggedOutEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new AccountLoginClusterLoggedOutEvent(node);
    }
  ...
  public static class ContentControlClusterRemainingScreenTimeExpiredEvent {
    ...
    public static ContentControlClusterRemainingScreenTimeExpiredEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class CommissionerControlClusterCommissioningRequestResultEvent {
    ...
    public CommissionerControlClusterCommissioningRequestResultEvent(
        Long requestId, Long clientNodeId, Integer statusCode, Integer fabricIndex) {
    ...
    public static CommissionerControlClusterCommissioningRequestResultEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new CommissionerControlClusterCommissioningRequestResultEvent(
          requestId, clientNodeId, statusCode, fabricIndex);
    }
  ...
  public static class UnitTestingClusterTestEventEvent {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ARG5_ID,
              ArrayType.generateArrayType(arg5, (elementarg5) -> elementarg5.encodeTlv())));
      values.add(
          new StructElement(
              ARG6_ID,
              ArrayType.generateArrayType(arg6, (elementarg6) -> new UIntType(elementarg6))));
    ...
    public static UnitTestingClusterTestEventEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UnitTestingClusterTestEventEvent(arg1, arg2, arg3, arg4, arg5, arg6);
    }
  ...
  public static class UnitTestingClusterTestFabricScopedEventEvent {
    ...
    public static UnitTestingClusterTestFabricScopedEventEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UnitTestingClusterTestFabricScopedEventEvent(fabricIndex);
    }
  ...
  public static class UnitTestingClusterTestDifferentVendorMeiEventEvent {
    ...
    public UnitTestingClusterTestDifferentVendorMeiEventEvent(Integer arg1) {
      this.arg1 = arg1;
    }
    ...
    public static UnitTestingClusterTestDifferentVendorMeiEventEvent decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new UnitTestingClusterTestDifferentVendorMeiEventEvent(arg1);
    }
  ...
  public static class SampleMeiClusterPingCountEventEvent {
    ...
    public SampleMeiClusterPingCountEventEvent(Long count, Integer fabricIndex) {
      this.count = count;
      this.fabricIndex = fabricIndex;
    }
    ...
    public static SampleMeiClusterPingCountEventEvent decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SampleMeiClusterPingCountEventEvent(count, fabricIndex);
    }

...
public class ChipStructs {
  public static class DescriptorClusterDeviceTypeStruct {
    ...
    public static DescriptorClusterDeviceTypeStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DescriptorClusterDeviceTypeStruct(deviceType, revision);
    }
  ...
  public static class DescriptorClusterSemanticTagStruct {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(MFG_CODE_ID, mfgCode != null ? new UIntType(mfgCode) : new NullType()));
      ...
      values.add(
          new StructElement(
              ...
              label != null
                  ? label
                      .<BaseTLVType>map((nonOptionallabel) -> new StringType(nonOptionallabel))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static DescriptorClusterSemanticTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DescriptorClusterSemanticTagStruct(mfgCode, namespaceID, tag, label);
    }
  ...
  public static class BindingClusterTargetStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              NODE_ID,
              node.<BaseTLVType>map((nonOptionalnode) -> new UIntType(nonOptionalnode))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              GROUP_ID,
              group
                  .<BaseTLVType>map((nonOptionalgroup) -> new UIntType(nonOptionalgroup))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              ENDPOINT_ID,
              endpoint
                  .<BaseTLVType>map((nonOptionalendpoint) -> new UIntType(nonOptionalendpoint))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              CLUSTER_ID,
              cluster
                  .<BaseTLVType>map((nonOptionalcluster) -> new UIntType(nonOptionalcluster))
                  .orElse(new EmptyType())));
    ...
    public static BindingClusterTargetStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BindingClusterTargetStruct(node, group, endpoint, cluster, fabricIndex);
    }
  ...
  public static class AccessControlClusterAccessControlTargetStruct {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(CLUSTER_ID, cluster != null ? new UIntType(cluster) : new NullType()));
      values.add(
          new StructElement(
              ENDPOINT_ID, endpoint != null ? new UIntType(endpoint) : new NullType()));
      values.add(
          new StructElement(
              DEVICE_TYPE_ID, deviceType != null ? new UIntType(deviceType) : new NullType()));
    ...
    public static AccessControlClusterAccessControlTargetStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new AccessControlClusterAccessControlTargetStruct(cluster, endpoint, deviceType);
    }
  ...
  public static class AccessControlClusterAccessControlEntryStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              SUBJECTS_ID,
              subjects != null
                  ? ArrayType.generateArrayType(
                      subjects, (elementsubjects) -> new UIntType(elementsubjects))
                  : new NullType()));
      values.add(
          new StructElement(
              TARGETS_ID,
              targets != null
                  ? ArrayType.generateArrayType(
                      targets, (elementtargets) -> elementtargets.encodeTlv())
                  : new NullType()));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));
    ...
    public static AccessControlClusterAccessControlEntryStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == PRIVILEGE_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            subjects =
                castingValue.map((elementcastingValue) -> elementcastingValue.value(Long.class));
          }
      ...
      return new AccessControlClusterAccessControlEntryStruct(
          privilege, authMode, subjects, targets, fabricIndex);
    }
  ...
  public static class AccessControlClusterAccessControlExtensionStruct {
    ...
    public static AccessControlClusterAccessControlExtensionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new AccessControlClusterAccessControlExtensionStruct(data, fabricIndex);
    }
  ...
  public static class ActionsClusterActionStruct {
    ...
    public static ActionsClusterActionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ActionsClusterActionStruct(
          actionID, name, type, endpointListID, supportedCommands, state);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ENDPOINTS_ID,
              ArrayType.generateArrayType(
                  endpoints, (elementendpoints) -> new UIntType(elementendpoints))));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ENDPOINT_LIST_I_D_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ArrayType castingValue = element.value(ArrayType.class);
            endpoints =
                castingValue.map((elementcastingValue) -> elementcastingValue.value(Integer.class));
          }
        }
      }
      return new ActionsClusterEndpointListStruct(endpointListID, name, type, endpoints);
    }
  ...
  public static class BasicInformationClusterCapabilityMinimaStruct {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(CASE_SESSIONS_PER_FABRIC_ID, new UIntType(caseSessionsPerFabric)));
      values.add(
          new StructElement(SUBSCRIPTIONS_PER_FABRIC_ID, new UIntType(subscriptionsPerFabric)));
  ...
  public static class BasicInformationClusterProductAppearanceStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              PRIMARY_COLOR_ID,
              primaryColor != null ? new UIntType(primaryColor) : new NullType()));
    ...
    public static BasicInformationClusterProductAppearanceStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new BasicInformationClusterProductAppearanceStruct(finish, primaryColor);
    }
  ...
  public static class OtaSoftwareUpdateRequestorClusterProviderLocation {
    ...
    public static OtaSoftwareUpdateRequestorClusterProviderLocation decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new OtaSoftwareUpdateRequestorClusterProviderLocation(
          providerNodeID, endpoint, fabricIndex);
    }
  ...
  public static class PowerSourceClusterBatChargeFaultChangeType {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              CURRENT_ID,
              ArrayType.generateArrayType(
                  current, (elementcurrent) -> new UIntType(elementcurrent))));
      values.add(
          new StructElement(
              PREVIOUS_ID,
              ArrayType.generateArrayType(
                  previous, (elementprevious) -> new UIntType(elementprevious))));
    ...
    public static PowerSourceClusterBatChargeFaultChangeType decodeTlv(BaseTLVType tlvValue) {
      ...
      return new PowerSourceClusterBatChargeFaultChangeType(current, previous);
    }
  ...
  public static class PowerSourceClusterBatFaultChangeType {
    ...
    public static PowerSourceClusterBatFaultChangeType decodeTlv(BaseTLVType tlvValue) {
      ...
      return new PowerSourceClusterBatFaultChangeType(current, previous);
    }
  ...
  public static class PowerSourceClusterWiredFaultChangeType {
    ...
    public static PowerSourceClusterWiredFaultChangeType decodeTlv(BaseTLVType tlvValue) {
      ...
      return new PowerSourceClusterWiredFaultChangeType(current, previous);
    }
  ...
  public static class GeneralCommissioningClusterBasicCommissioningInfo {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              FAIL_SAFE_EXPIRY_LENGTH_SECONDS_ID, new UIntType(failSafeExpiryLengthSeconds)));
      values.add(
          new StructElement(
              MAX_CUMULATIVE_FAILSAFE_SECONDS_ID, new UIntType(maxCumulativeFailsafeSeconds)));

      return new StructType(values);
    }

    public static GeneralCommissioningClusterBasicCommissioningInfo decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new GeneralCommissioningClusterBasicCommissioningInfo(
          failSafeExpiryLengthSeconds, maxCumulativeFailsafeSeconds);
    }
      ...
      values.add(
          new StructElement(
              ...
              networkIdentifier != null
                  ? networkIdentifier
                      .<BaseTLVType>map(
                          (nonOptionalnetworkIdentifier) ->
                              new ByteArrayType(nonOptionalnetworkIdentifier))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              clientIdentifier != null
                  ? clientIdentifier
                      .<BaseTLVType>map(
                          (nonOptionalclientIdentifier) ->
                              new ByteArrayType(nonOptionalclientIdentifier))
                      .orElse(new EmptyType())
                  : new NullType()));
  ...
  public static class NetworkCommissioningClusterThreadInterfaceScanResultStruct {
    ...
    public static NetworkCommissioningClusterThreadInterfaceScanResultStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class NetworkCommissioningClusterWiFiInterfaceScanResultStruct {
    ...
    public static NetworkCommissioningClusterWiFiInterfaceScanResultStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new NetworkCommissioningClusterWiFiInterfaceScanResultStruct(
          security, ssid, bssid, channel, wiFiBand, rssi);
    }
  ...
  public static class GeneralDiagnosticsClusterNetworkInterface {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              OFF_PREMISE_SERVICES_REACHABLE_I_PV4_ID,
              offPremiseServicesReachableIPv4 != null
                  ? new BooleanType(offPremiseServicesReachableIPv4)
                  : new NullType()));
      values.add(
          new StructElement(
              OFF_PREMISE_SERVICES_REACHABLE_I_PV6_ID,
              offPremiseServicesReachableIPv6 != null
                  ? new BooleanType(offPremiseServicesReachableIPv6)
                  : new NullType()));
      ...
      values.add(
          new StructElement(
              ...
              ArrayType.generateArrayType(
                  IPv4Addresses,
                  (elementIPv4Addresses) -> new ByteArrayType(elementIPv4Addresses))));
      values.add(
          new StructElement(
              I_PV6_ADDRESSES_ID,
              ArrayType.generateArrayType(
                  IPv6Addresses,
                  (elementIPv6Addresses) -> new ByteArrayType(elementIPv6Addresses))));
      values.add(new StructElement(TYPE_ID, new UIntType(type)));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == NAME_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ArrayType castingValue = element.value(ArrayType.class);
            IPv4Addresses =
                castingValue.map((elementcastingValue) -> elementcastingValue.value(byte[].class));
          }
  ...
  public static class SoftwareDiagnosticsClusterThreadMetricsStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              NAME_ID,
              name.<BaseTLVType>map((nonOptionalname) -> new StringType(nonOptionalname))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              STACK_FREE_CURRENT_ID,
              stackFreeCurrent
                  .<BaseTLVType>map(
                      (nonOptionalstackFreeCurrent) -> new UIntType(nonOptionalstackFreeCurrent))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              STACK_FREE_MINIMUM_ID,
              stackFreeMinimum
                  .<BaseTLVType>map(
                      (nonOptionalstackFreeMinimum) -> new UIntType(nonOptionalstackFreeMinimum))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              STACK_SIZE_ID,
              stackSize
                  .<BaseTLVType>map((nonOptionalstackSize) -> new UIntType(nonOptionalstackSize))
                  .orElse(new EmptyType())));
    ...
    public static SoftwareDiagnosticsClusterThreadMetricsStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new SoftwareDiagnosticsClusterThreadMetricsStruct(
          id, name, stackFreeCurrent, stackFreeMinimum, stackSize);
    }
  ...
  public static class ThreadNetworkDiagnosticsClusterNeighborTableStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              AVERAGE_RSSI_ID, averageRssi != null ? new IntType(averageRssi) : new NullType()));
      values.add(
          new StructElement(
              LAST_RSSI_ID, lastRssi != null ? new IntType(lastRssi) : new NullType()));
    ...
    public static ThreadNetworkDiagnosticsClusterNeighborTableStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ThreadNetworkDiagnosticsClusterOperationalDatasetComponents {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(ACTIVE_TIMESTAMP_PRESENT_ID, new BooleanType(activeTimestampPresent)));
      values.add(
          new StructElement(
              PENDING_TIMESTAMP_PRESENT_ID, new BooleanType(pendingTimestampPresent)));
      ...
      values.add(
          new StructElement(EXTENDED_PAN_ID_PRESENT_ID, new BooleanType(extendedPanIdPresent)));
      values.add(
          new StructElement(MESH_LOCAL_PREFIX_PRESENT_ID, new BooleanType(meshLocalPrefixPresent)));
      ...
      values.add(
          new StructElement(SECURITY_POLICY_PRESENT_ID, new BooleanType(securityPolicyPresent)));
      values.add(new StructElement(CHANNEL_MASK_PRESENT_ID, new BooleanType(channelMaskPresent)));

      return new StructType(values);
    }

    public static ThreadNetworkDiagnosticsClusterOperationalDatasetComponents decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ThreadNetworkDiagnosticsClusterSecurityPolicy {
    ...
    public static ThreadNetworkDiagnosticsClusterSecurityPolicy decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThreadNetworkDiagnosticsClusterSecurityPolicy(rotationTime, flags);
    }
  ...
  public static class TimeSynchronizationClusterDSTOffsetStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              VALID_UNTIL_ID, validUntil != null ? new UIntType(validUntil) : new NullType()));
    ...
    public static TimeSynchronizationClusterDSTOffsetStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new TimeSynchronizationClusterDSTOffsetStruct(offset, validStarting, validUntil);
    }
  ...
  public static class TimeSynchronizationClusterFabricScopedTrustedTimeSourceStruct {
    ...
    public static TimeSynchronizationClusterFabricScopedTrustedTimeSourceStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new TimeSynchronizationClusterFabricScopedTrustedTimeSourceStruct(nodeID, endpoint);
    }
  ...
  public static class TimeSynchronizationClusterTimeZoneStruct {
    ...
    public static TimeSynchronizationClusterTimeZoneStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new TimeSynchronizationClusterTimeZoneStruct(offset, validAt, name);
    }
  ...
  public static class TimeSynchronizationClusterTrustedTimeSourceStruct {
    ...
    public static TimeSynchronizationClusterTrustedTimeSourceStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new TimeSynchronizationClusterTrustedTimeSourceStruct(fabricIndex, nodeID, endpoint);
    }
  ...
  public static class BridgedDeviceBasicInformationClusterProductAppearanceStruct {
    ...
    public static BridgedDeviceBasicInformationClusterProductAppearanceStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new BridgedDeviceBasicInformationClusterProductAppearanceStruct(finish, primaryColor);
    }
  ...
  public static class OperationalCredentialsClusterFabricDescriptorStruct {
    ...
    public static OperationalCredentialsClusterFabricDescriptorStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class OperationalCredentialsClusterNOCStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(ICAC_ID, icac != null ? new ByteArrayType(icac) : new NullType()));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));
    ...
    public static OperationalCredentialsClusterNOCStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new OperationalCredentialsClusterNOCStruct(noc, icac, fabricIndex);
    }
  ...
  public static class GroupKeyManagementClusterGroupInfoMapStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              GROUP_NAME_ID,
              groupName
                  .<BaseTLVType>map((nonOptionalgroupName) -> new StringType(nonOptionalgroupName))
                  .orElse(new EmptyType())));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));
    ...
    public static GroupKeyManagementClusterGroupInfoMapStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new GroupKeyManagementClusterGroupInfoMapStruct(
          groupId, endpoints, groupName, fabricIndex);
    }
  ...
  public static class GroupKeyManagementClusterGroupKeyMapStruct {
    ...
    public static GroupKeyManagementClusterGroupKeyMapStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new GroupKeyManagementClusterGroupKeyMapStruct(groupId, groupKeySetID, fabricIndex);
    }
  ...
  public static class GroupKeyManagementClusterGroupKeySetStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(new StructElement(GROUP_KEY_SET_I_D_ID, new UIntType(groupKeySetID)));
      values.add(
          new StructElement(GROUP_KEY_SECURITY_POLICY_ID, new UIntType(groupKeySecurityPolicy)));
      values.add(
          new StructElement(
              EPOCH_KEY0_ID, epochKey0 != null ? new ByteArrayType(epochKey0) : new NullType()));
      values.add(
          new StructElement(
              EPOCH_START_TIME0_ID,
              epochStartTime0 != null ? new UIntType(epochStartTime0) : new NullType()));
      values.add(
          new StructElement(
              EPOCH_KEY1_ID, epochKey1 != null ? new ByteArrayType(epochKey1) : new NullType()));
      values.add(
          new StructElement(
              EPOCH_START_TIME1_ID,
              epochStartTime1 != null ? new UIntType(epochStartTime1) : new NullType()));
      values.add(
          new StructElement(
              EPOCH_KEY2_ID, epochKey2 != null ? new ByteArrayType(epochKey2) : new NullType()));
      values.add(
          new StructElement(
              EPOCH_START_TIME2_ID,
              epochStartTime2 != null ? new UIntType(epochStartTime2) : new NullType()));
  ...
  public static class FixedLabelClusterLabelStruct {
    ...
    public static FixedLabelClusterLabelStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new FixedLabelClusterLabelStruct(label, value);
    }
  ...
  public static class UserLabelClusterLabelStruct {
    ...
    public static UserLabelClusterLabelStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UserLabelClusterLabelStruct(label, value);
    }
  ...
  public static class IcdManagementClusterMonitoringRegistrationStruct {
    ...
    public IcdManagementClusterMonitoringRegistrationStruct(
        Long checkInNodeID, Long monitoredSubject, Integer clientType, Integer fabricIndex) {
    ...
    public static IcdManagementClusterMonitoringRegistrationStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new IcdManagementClusterMonitoringRegistrationStruct(
          checkInNodeID, monitoredSubject, clientType, fabricIndex);
    }
  ...
  public static class OvenCavityOperationalStateClusterErrorStateStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ERROR_STATE_LABEL_ID,
              errorStateLabel
                  .<BaseTLVType>map(
                      (nonOptionalerrorStateLabel) -> new StringType(nonOptionalerrorStateLabel))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              ERROR_STATE_DETAILS_ID,
              errorStateDetails
                  .<BaseTLVType>map(
                      (nonOptionalerrorStateDetails) ->
                          new StringType(nonOptionalerrorStateDetails))
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static OvenCavityOperationalStateClusterErrorStateStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class OvenCavityOperationalStateClusterOperationalStateStruct {
    ...
    public OvenCavityOperationalStateClusterOperationalStateStruct(
        Integer operationalStateID, Optional<String> operationalStateLabel) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              OPERATIONAL_STATE_LABEL_ID,
              operationalStateLabel
                  .<BaseTLVType>map(
                      (nonOptionaloperationalStateLabel) ->
                          new StringType(nonOptionaloperationalStateLabel))
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static OvenCavityOperationalStateClusterOperationalStateStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class OvenModeClusterModeTagStruct {
    ...
    public OvenModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              MFG_CODE_ID,
              mfgCode
                  .<BaseTLVType>map((nonOptionalmfgCode) -> new UIntType(nonOptionalmfgCode))
                  .orElse(new EmptyType())));
    ...
    public static OvenModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new OvenModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class OvenModeClusterModeOptionStruct {
    ...
    public OvenModeClusterModeOptionStruct(
        String label, Integer mode, ArrayList<ChipStructs.OvenModeClusterModeTagStruct> modeTags) {
      this.label = label;
      this.mode = mode;
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              MODE_TAGS_ID,
              ArrayType.generateArrayType(
                  modeTags, (elementmodeTags) -> elementmodeTags.encodeTlv())));
        ...
        if (element.contextTagNum() == LABEL_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            modeTags =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.OvenModeClusterModeTagStruct.decodeTlv(elementcastingValue));
          }
        }
      }
      return new OvenModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class ModeSelectClusterSemanticTagStruct {
    ...
    public static ModeSelectClusterSemanticTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ModeSelectClusterSemanticTagStruct(mfgCode, value);
    }
  ...
  public static class ModeSelectClusterModeOptionStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              SEMANTIC_TAGS_ID,
              ArrayType.generateArrayType(
                  semanticTags, (elementsemanticTags) -> elementsemanticTags.encodeTlv())));
    ...
    public static ModeSelectClusterModeOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ModeSelectClusterModeOptionStruct(label, mode, semanticTags);
    }
  ...
  public static class LaundryWasherModeClusterModeTagStruct {
    ...
    public LaundryWasherModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static LaundryWasherModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new LaundryWasherModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class LaundryWasherModeClusterModeOptionStruct {
    ...
    public static LaundryWasherModeClusterModeOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new LaundryWasherModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class RefrigeratorAndTemperatureControlledCabinetModeClusterModeTagStruct {
    ...
    public RefrigeratorAndTemperatureControlledCabinetModeClusterModeTagStruct(
        Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static RefrigeratorAndTemperatureControlledCabinetModeClusterModeTagStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct {
    ...
    public RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct(
        String label,
        Integer mode,
        ArrayList<ChipStructs.RefrigeratorAndTemperatureControlledCabinetModeClusterModeTagStruct>
            modeTags) {
      this.label = label;
      this.mode = mode;
      this.modeTags = modeTags;
    ...
    public static RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class RvcRunModeClusterModeTagStruct {
    ...
    public RvcRunModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static RvcRunModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new RvcRunModeClusterModeTagStruct(mfgCode, value);
    }
        ...
        if (element.contextTagNum() == LABEL_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            modeTags =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.RvcRunModeClusterModeTagStruct.decodeTlv(elementcastingValue));
          }
        }
      }
      return new RvcRunModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class RvcCleanModeClusterModeTagStruct {
    ...
    public RvcCleanModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static RvcCleanModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new RvcCleanModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class RvcCleanModeClusterModeOptionStruct {
    ...
    public static RvcCleanModeClusterModeOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new RvcCleanModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class DishwasherModeClusterModeTagStruct {
    ...
    public DishwasherModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static DishwasherModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DishwasherModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class DishwasherModeClusterModeOptionStruct {
    ...
    public static DishwasherModeClusterModeOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DishwasherModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class MicrowaveOvenModeClusterModeTagStruct {
    ...
    public MicrowaveOvenModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static MicrowaveOvenModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MicrowaveOvenModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class MicrowaveOvenModeClusterModeOptionStruct {
    ...
    public static MicrowaveOvenModeClusterModeOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MicrowaveOvenModeClusterModeOptionStruct(label, mode, modeTags);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              valueUnsigned8
                  .<BaseTLVType>map(
                      (nonOptionalvalueUnsigned8) -> new UIntType(nonOptionalvalueUnsigned8))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_SIGNED8_ID,
              valueSigned8
                  .<BaseTLVType>map(
                      (nonOptionalvalueSigned8) -> new IntType(nonOptionalvalueSigned8))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_UNSIGNED16_ID,
              valueUnsigned16
                  .<BaseTLVType>map(
                      (nonOptionalvalueUnsigned16) -> new UIntType(nonOptionalvalueUnsigned16))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_SIGNED16_ID,
              valueSigned16
                  .<BaseTLVType>map(
                      (nonOptionalvalueSigned16) -> new IntType(nonOptionalvalueSigned16))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_UNSIGNED32_ID,
              valueUnsigned32
                  .<BaseTLVType>map(
                      (nonOptionalvalueUnsigned32) -> new UIntType(nonOptionalvalueUnsigned32))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_SIGNED32_ID,
              valueSigned32
                  .<BaseTLVType>map(
                      (nonOptionalvalueSigned32) -> new IntType(nonOptionalvalueSigned32))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_UNSIGNED64_ID,
              valueUnsigned64
                  .<BaseTLVType>map(
                      (nonOptionalvalueUnsigned64) -> new UIntType(nonOptionalvalueUnsigned64))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              VALUE_SIGNED64_ID,
              valueSigned64
                  .<BaseTLVType>map(
                      (nonOptionalvalueSigned64) -> new IntType(nonOptionalvalueSigned64))
                  .orElse(new EmptyType())));
  ...
  public static class ScenesManagementClusterExtensionFieldSet {
    ...
    public ArrayList<ChipStructs.ScenesManagementClusterAttributeValuePairStruct>
        attributeValueList;
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              ArrayType.generateArrayType(
                  attributeValueList,
                  (elementattributeValueList) -> elementattributeValueList.encodeTlv())));
        ...
        if (element.contextTagNum() == CLUSTER_I_D_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            attributeValueList =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.ScenesManagementClusterAttributeValuePairStruct.decodeTlv(
                            elementcastingValue));
          }
        }
      }
      return new ScenesManagementClusterExtensionFieldSet(clusterID, attributeValueList);
    }
  ...
  public static class HepaFilterMonitoringClusterReplacementProductStruct {
    ...
    public HepaFilterMonitoringClusterReplacementProductStruct(
        Integer productIdentifierType, String productIdentifierValue) {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(PRODUCT_IDENTIFIER_TYPE_ID, new UIntType(productIdentifierType)));
      values.add(
          new StructElement(PRODUCT_IDENTIFIER_VALUE_ID, new StringType(productIdentifierValue)));

      return new StructType(values);
    }

    public static HepaFilterMonitoringClusterReplacementProductStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ActivatedCarbonFilterMonitoringClusterReplacementProductStruct {
    ...
    public static ActivatedCarbonFilterMonitoringClusterReplacementProductStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              PERCENT_MAX_ID,
              percentMax
                  .<BaseTLVType>map((nonOptionalpercentMax) -> new UIntType(nonOptionalpercentMax))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              PERCENT_MIN_ID,
              percentMin
                  .<BaseTLVType>map((nonOptionalpercentMin) -> new UIntType(nonOptionalpercentMin))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              PERCENT_TYPICAL_ID,
              percentTypical
                  .<BaseTLVType>map(
                      (nonOptionalpercentTypical) -> new UIntType(nonOptionalpercentTypical))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              FIXED_MAX_ID,
              fixedMax
                  .<BaseTLVType>map((nonOptionalfixedMax) -> new UIntType(nonOptionalfixedMax))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              FIXED_MIN_ID,
              fixedMin
                  .<BaseTLVType>map((nonOptionalfixedMin) -> new UIntType(nonOptionalfixedMin))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              FIXED_TYPICAL_ID,
              fixedTypical
                  .<BaseTLVType>map(
                      (nonOptionalfixedTypical) -> new UIntType(nonOptionalfixedTypical))
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static ElectricalPowerMeasurementClusterMeasurementAccuracyRangeStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ElectricalPowerMeasurementClusterMeasurementAccuracyStruct {
    ...
    public ArrayList<ChipStructs.ElectricalPowerMeasurementClusterMeasurementAccuracyRangeStruct>
        accuracyRanges;
    ...
    public ElectricalPowerMeasurementClusterMeasurementAccuracyStruct(
        ...
        ArrayList<ChipStructs.ElectricalPowerMeasurementClusterMeasurementAccuracyRangeStruct>
            accuracyRanges) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ACCURACY_RANGES_ID,
              ArrayType.generateArrayType(
                  accuracyRanges, (elementaccuracyRanges) -> elementaccuracyRanges.encodeTlv())));

      return new StructType(values);
    }

    public static ElectricalPowerMeasurementClusterMeasurementAccuracyStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ElectricalPowerMeasurementClusterHarmonicMeasurementStruct {
    ...
    public ElectricalPowerMeasurementClusterHarmonicMeasurementStruct(
        Integer order, @Nullable Long measurement) {
      this.order = order;
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              MEASUREMENT_ID, measurement != null ? new IntType(measurement) : new NullType()));

      return new StructType(values);
    }

    public static ElectricalPowerMeasurementClusterHarmonicMeasurementStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new ElectricalPowerMeasurementClusterHarmonicMeasurementStruct(order, measurement);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              startTimestamp
                  .<BaseTLVType>map(
                      (nonOptionalstartTimestamp) -> new UIntType(nonOptionalstartTimestamp))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              END_TIMESTAMP_ID,
              endTimestamp
                  .<BaseTLVType>map(
                      (nonOptionalendTimestamp) -> new UIntType(nonOptionalendTimestamp))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MIN_TIMESTAMP_ID,
              minTimestamp
                  .<BaseTLVType>map(
                      (nonOptionalminTimestamp) -> new UIntType(nonOptionalminTimestamp))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MAX_TIMESTAMP_ID,
              maxTimestamp
                  .<BaseTLVType>map(
                      (nonOptionalmaxTimestamp) -> new UIntType(nonOptionalmaxTimestamp))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              START_SYSTIME_ID,
              startSystime
                  .<BaseTLVType>map(
                      (nonOptionalstartSystime) -> new UIntType(nonOptionalstartSystime))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              END_SYSTIME_ID,
              endSystime
                  .<BaseTLVType>map((nonOptionalendSystime) -> new UIntType(nonOptionalendSystime))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MIN_SYSTIME_ID,
              minSystime
                  .<BaseTLVType>map((nonOptionalminSystime) -> new UIntType(nonOptionalminSystime))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MAX_SYSTIME_ID,
              maxSystime
                  .<BaseTLVType>map((nonOptionalmaxSystime) -> new UIntType(nonOptionalmaxSystime))
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static ElectricalPowerMeasurementClusterMeasurementRangeStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct {
    ...
    public static ElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ElectricalEnergyMeasurementClusterMeasurementAccuracyStruct {
    ...
    public Long minMeasuredValue;
    public Long maxMeasuredValue;
    public ArrayList<ChipStructs.ElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct>
        accuracyRanges;
    private static final long MEASUREMENT_TYPE_ID = 0L;
    private static final long MEASURED_ID = 1L;
    private static final long MIN_MEASURED_VALUE_ID = 2L;
    ...
    public ElectricalEnergyMeasurementClusterMeasurementAccuracyStruct(
        ...
        Long minMeasuredValue,
        Long maxMeasuredValue,
        ArrayList<ChipStructs.ElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct>
            accuracyRanges) {
      this.measurementType = measurementType;
      this.measured = measured;
      this.minMeasuredValue = minMeasuredValue;
    ...
    public static ElectricalEnergyMeasurementClusterMeasurementAccuracyStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
        ...
        if (element.contextTagNum() == MEASUREMENT_TYPE_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            accuracyRanges =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.ElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct
                            .decodeTlv(elementcastingValue));
          }
        }
      }
  ...
  public static class ElectricalEnergyMeasurementClusterCumulativeEnergyResetStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              IMPORTED_RESET_TIMESTAMP_ID,
              importedResetTimestamp != null
                  ? importedResetTimestamp
                      .<BaseTLVType>map(
                          (nonOptionalimportedResetTimestamp) ->
                              new UIntType(nonOptionalimportedResetTimestamp))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              EXPORTED_RESET_TIMESTAMP_ID,
              exportedResetTimestamp != null
                  ? exportedResetTimestamp
                      .<BaseTLVType>map(
                          (nonOptionalexportedResetTimestamp) ->
                              new UIntType(nonOptionalexportedResetTimestamp))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              IMPORTED_RESET_SYSTIME_ID,
              importedResetSystime != null
                  ? importedResetSystime
                      .<BaseTLVType>map(
                          (nonOptionalimportedResetSystime) ->
                              new UIntType(nonOptionalimportedResetSystime))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              EXPORTED_RESET_SYSTIME_ID,
              exportedResetSystime != null
                  ? exportedResetSystime
                      .<BaseTLVType>map(
                          (nonOptionalexportedResetSystime) ->
                              new UIntType(nonOptionalexportedResetSystime))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static ElectricalEnergyMeasurementClusterCumulativeEnergyResetStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class ElectricalEnergyMeasurementClusterEnergyMeasurementStruct {
    ...
    public static ElectricalEnergyMeasurementClusterEnergyMeasurementStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class DemandResponseLoadControlClusterHeatingSourceControlStruct {
    ...
    public DemandResponseLoadControlClusterHeatingSourceControlStruct(Integer heatingSource) {
    ...
    public static DemandResponseLoadControlClusterHeatingSourceControlStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new DemandResponseLoadControlClusterHeatingSourceControlStruct(heatingSource);
    }
  ...
  public static class DemandResponseLoadControlClusterPowerSavingsControlStruct {
    ...
    public DemandResponseLoadControlClusterPowerSavingsControlStruct(Integer powerSavings) {
    ...
    public static DemandResponseLoadControlClusterPowerSavingsControlStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new DemandResponseLoadControlClusterPowerSavingsControlStruct(powerSavings);
    }
  ...
  public static class DemandResponseLoadControlClusterDutyCycleControlStruct {
    ...
    public DemandResponseLoadControlClusterDutyCycleControlStruct(Integer dutyCycle) {
    ...
    public static DemandResponseLoadControlClusterDutyCycleControlStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new DemandResponseLoadControlClusterDutyCycleControlStruct(dutyCycle);
    }
  ...
  public static class DemandResponseLoadControlClusterAverageLoadControlStruct {
    ...
    public DemandResponseLoadControlClusterAverageLoadControlStruct(Integer loadAdjustment) {
    ...
    public static DemandResponseLoadControlClusterAverageLoadControlStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new DemandResponseLoadControlClusterAverageLoadControlStruct(loadAdjustment);
    }
  ...
  public static class DemandResponseLoadControlClusterTemperatureControlStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              COOLING_TEMP_OFFSET_ID,
              coolingTempOffset != null
                  ? coolingTempOffset
                      .<BaseTLVType>map(
                          (nonOptionalcoolingTempOffset) ->
                              new UIntType(nonOptionalcoolingTempOffset))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              HEATINGT_TEMP_OFFSET_ID,
              heatingtTempOffset != null
                  ? heatingtTempOffset
                      .<BaseTLVType>map(
                          (nonOptionalheatingtTempOffset) ->
                              new UIntType(nonOptionalheatingtTempOffset))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              COOLING_TEMP_SETPOINT_ID,
              coolingTempSetpoint != null
                  ? coolingTempSetpoint
                      .<BaseTLVType>map(
                          (nonOptionalcoolingTempSetpoint) ->
                              new IntType(nonOptionalcoolingTempSetpoint))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              HEATING_TEMP_SETPOINT_ID,
              heatingTempSetpoint != null
                  ? heatingTempSetpoint
                      .<BaseTLVType>map(
                          (nonOptionalheatingTempSetpoint) ->
                              new IntType(nonOptionalheatingTempSetpoint))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static DemandResponseLoadControlClusterTemperatureControlStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class DemandResponseLoadControlClusterLoadControlEventTransitionStruct {
    ...
    public Optional<ChipStructs.DemandResponseLoadControlClusterTemperatureControlStruct>
        temperatureControl;
    public Optional<ChipStructs.DemandResponseLoadControlClusterAverageLoadControlStruct>
        averageLoadControl;
    public Optional<ChipStructs.DemandResponseLoadControlClusterDutyCycleControlStruct>
        dutyCycleControl;
    public Optional<ChipStructs.DemandResponseLoadControlClusterPowerSavingsControlStruct>
        powerSavingsControl;
    public Optional<ChipStructs.DemandResponseLoadControlClusterHeatingSourceControlStruct>
    ...
    public DemandResponseLoadControlClusterLoadControlEventTransitionStruct(
        Integer duration,
        Integer control,
        Optional<ChipStructs.DemandResponseLoadControlClusterTemperatureControlStruct>
            temperatureControl,
        Optional<ChipStructs.DemandResponseLoadControlClusterAverageLoadControlStruct>
            averageLoadControl,
        Optional<ChipStructs.DemandResponseLoadControlClusterDutyCycleControlStruct>
            dutyCycleControl,
        Optional<ChipStructs.DemandResponseLoadControlClusterPowerSavingsControlStruct>
            powerSavingsControl,
        Optional<ChipStructs.DemandResponseLoadControlClusterHeatingSourceControlStruct>
            heatingSourceControl) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              temperatureControl
                  .<BaseTLVType>map(
                      (nonOptionaltemperatureControl) -> nonOptionaltemperatureControl.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              AVERAGE_LOAD_CONTROL_ID,
              averageLoadControl
                  .<BaseTLVType>map(
                      (nonOptionalaverageLoadControl) -> nonOptionalaverageLoadControl.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              DUTY_CYCLE_CONTROL_ID,
              dutyCycleControl
                  .<BaseTLVType>map(
                      (nonOptionaldutyCycleControl) -> nonOptionaldutyCycleControl.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              POWER_SAVINGS_CONTROL_ID,
              powerSavingsControl
                  .<BaseTLVType>map(
                      (nonOptionalpowerSavingsControl) ->
                          nonOptionalpowerSavingsControl.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              HEATING_SOURCE_CONTROL_ID,
              heatingSourceControl
                  .<BaseTLVType>map(
                      (nonOptionalheatingSourceControl) ->
                          nonOptionalheatingSourceControl.encodeTlv())
                  .orElse(new EmptyType())));

      return new StructType(values);
    }

    public static DemandResponseLoadControlClusterLoadControlEventTransitionStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      Optional<ChipStructs.DemandResponseLoadControlClusterTemperatureControlStruct>
          temperatureControl = Optional.empty();
      Optional<ChipStructs.DemandResponseLoadControlClusterAverageLoadControlStruct>
          averageLoadControl = Optional.empty();
      Optional<ChipStructs.DemandResponseLoadControlClusterDutyCycleControlStruct>
          dutyCycleControl = Optional.empty();
      Optional<ChipStructs.DemandResponseLoadControlClusterPowerSavingsControlStruct>
          powerSavingsControl = Optional.empty();
      Optional<ChipStructs.DemandResponseLoadControlClusterHeatingSourceControlStruct>
          heatingSourceControl = Optional.empty();
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == DURATION_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            temperatureControl =
                Optional.of(
                    ChipStructs.DemandResponseLoadControlClusterTemperatureControlStruct.decodeTlv(
                        castingValue));
          }
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            averageLoadControl =
                Optional.of(
                    ChipStructs.DemandResponseLoadControlClusterAverageLoadControlStruct.decodeTlv(
                        castingValue));
          }
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            dutyCycleControl =
                Optional.of(
                    ChipStructs.DemandResponseLoadControlClusterDutyCycleControlStruct.decodeTlv(
                        castingValue));
          }
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            powerSavingsControl =
                Optional.of(
                    ChipStructs.DemandResponseLoadControlClusterPowerSavingsControlStruct.decodeTlv(
                        castingValue));
          }
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            heatingSourceControl =
                Optional.of(
                    ChipStructs.DemandResponseLoadControlClusterHeatingSourceControlStruct
                        .decodeTlv(castingValue));
          }
        }
      }
  ...
  public static class DemandResponseLoadControlClusterLoadControlEventStruct {
    ...
    public ArrayList<ChipStructs.DemandResponseLoadControlClusterLoadControlEventTransitionStruct>
        transitions;
    ...
    public DemandResponseLoadControlClusterLoadControlEventStruct(
        ...
        ArrayList<ChipStructs.DemandResponseLoadControlClusterLoadControlEventTransitionStruct>
            transitions) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              PROGRAM_I_D_ID, programID != null ? new ByteArrayType(programID) : new NullType()));
      values.add(new StructElement(CONTROL_ID, new UIntType(control)));
      ...
      values.add(
          new StructElement(
              ...
              enrollmentGroup
                  .<BaseTLVType>map(
                      (nonOptionalenrollmentGroup) -> new UIntType(nonOptionalenrollmentGroup))
                  .orElse(new EmptyType())));
      values.add(new StructElement(CRITICALITY_ID, new UIntType(criticality)));
      values.add(
          new StructElement(
              START_TIME_ID, startTime != null ? new UIntType(startTime) : new NullType()));
      values.add(
          new StructElement(
              TRANSITIONS_ID,
              ArrayType.generateArrayType(
                  transitions, (elementtransitions) -> elementtransitions.encodeTlv())));

      return new StructType(values);
    }

    public static DemandResponseLoadControlClusterLoadControlEventStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class DemandResponseLoadControlClusterLoadControlProgramStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ENROLLMENT_GROUP_ID,
              enrollmentGroup != null ? new UIntType(enrollmentGroup) : new NullType()));
      values.add(
          new StructElement(
              RANDOM_START_MINUTES_ID,
              randomStartMinutes != null ? new UIntType(randomStartMinutes) : new NullType()));
      values.add(
          new StructElement(
              RANDOM_DURATION_MINUTES_ID,
              randomDurationMinutes != null
                  ? new UIntType(randomDurationMinutes)
                  : new NullType()));

      return new StructType(values);
    }

    public static DemandResponseLoadControlClusterLoadControlProgramStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class MessagesClusterMessageResponseOptionStruct {
    ...
    public MessagesClusterMessageResponseOptionStruct(
        Optional<Long> messageResponseID, Optional<String> label) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              MESSAGE_RESPONSE_I_D_ID,
              messageResponseID
                  .<BaseTLVType>map(
                      (nonOptionalmessageResponseID) -> new UIntType(nonOptionalmessageResponseID))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              LABEL_ID,
    ...
    public static MessagesClusterMessageResponseOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MessagesClusterMessageResponseOptionStruct(messageResponseID, label);
    }
  ...
  public static class MessagesClusterMessageStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              DURATION_ID, duration != null ? new UIntType(duration) : new NullType()));
      ...
      values.add(
          new StructElement(
              ...
              responses
                  .<BaseTLVType>map(
                      (nonOptionalresponses) ->
                          ArrayType.generateArrayType(
                              nonOptionalresponses,
                              (elementnonOptionalresponses) ->
                                  elementnonOptionalresponses.encodeTlv()))
                  .orElse(new EmptyType())));
  ...
  public static class DeviceEnergyManagementClusterCostStruct {
    ...
    public DeviceEnergyManagementClusterCostStruct(
        Integer costType, Long value, Integer decimalPoints, Optional<Integer> currency) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              CURRENCY_ID,
              currency
                  .<BaseTLVType>map((nonOptionalcurrency) -> new UIntType(nonOptionalcurrency))
                  .orElse(new EmptyType())));
    ...
    public static DeviceEnergyManagementClusterCostStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DeviceEnergyManagementClusterCostStruct(costType, value, decimalPoints, currency);
    }
  ...
  public static class DeviceEnergyManagementClusterPowerAdjustStruct {
    ...
    public DeviceEnergyManagementClusterPowerAdjustStruct(
        Long minPower, Long maxPower, Long minDuration, Long maxDuration) {
  ...
  public static class DeviceEnergyManagementClusterPowerAdjustCapabilityStruct {
    public @Nullable ArrayList<ChipStructs.DeviceEnergyManagementClusterPowerAdjustStruct>
    ...
    public DeviceEnergyManagementClusterPowerAdjustCapabilityStruct(
        @Nullable
            ArrayList<ChipStructs.DeviceEnergyManagementClusterPowerAdjustStruct>
                powerAdjustCapability,
        Integer cause) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              POWER_ADJUST_CAPABILITY_ID,
              powerAdjustCapability != null
                  ? ArrayType.generateArrayType(
                      powerAdjustCapability,
                      (elementpowerAdjustCapability) -> elementpowerAdjustCapability.encodeTlv())
                  : new NullType()));
    ...
    public static DeviceEnergyManagementClusterPowerAdjustCapabilityStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      @Nullable
      ArrayList<ChipStructs.DeviceEnergyManagementClusterPowerAdjustStruct> powerAdjustCapability =
          null;
      Integer cause = null;
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == POWER_ADJUST_CAPABILITY_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            powerAdjustCapability =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.DeviceEnergyManagementClusterPowerAdjustStruct.decodeTlv(
                            elementcastingValue));
          }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              slotIsPausable
                  .<BaseTLVType>map(
                      (nonOptionalslotIsPausable) -> new BooleanType(nonOptionalslotIsPausable))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MIN_PAUSE_DURATION_ID,
              minPauseDuration
                  .<BaseTLVType>map(
                      (nonOptionalminPauseDuration) -> new UIntType(nonOptionalminPauseDuration))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MAX_PAUSE_DURATION_ID,
              maxPauseDuration
                  .<BaseTLVType>map(
                      (nonOptionalmaxPauseDuration) -> new UIntType(nonOptionalmaxPauseDuration))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MANUFACTURER_E_S_A_STATE_ID,
              manufacturerESAState
                  .<BaseTLVType>map(
                      (nonOptionalmanufacturerESAState) ->
                          new UIntType(nonOptionalmanufacturerESAState))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NOMINAL_POWER_ID,
              nominalPower
                  .<BaseTLVType>map(
                      (nonOptionalnominalPower) -> new IntType(nonOptionalnominalPower))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MIN_POWER_ID,
              minPower
                  .<BaseTLVType>map((nonOptionalminPower) -> new IntType(nonOptionalminPower))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MAX_POWER_ID,
              maxPower
                  .<BaseTLVType>map((nonOptionalmaxPower) -> new IntType(nonOptionalmaxPower))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NOMINAL_ENERGY_ID,
              nominalEnergy
                  .<BaseTLVType>map(
                      (nonOptionalnominalEnergy) -> new IntType(nonOptionalnominalEnergy))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              COSTS_ID,
              costs
                  .<BaseTLVType>map(
                      (nonOptionalcosts) ->
                          ArrayType.generateArrayType(
                              nonOptionalcosts,
                              (elementnonOptionalcosts) -> elementnonOptionalcosts.encodeTlv()))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MIN_POWER_ADJUSTMENT_ID,
              minPowerAdjustment
                  .<BaseTLVType>map(
                      (nonOptionalminPowerAdjustment) -> new IntType(nonOptionalminPowerAdjustment))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MAX_POWER_ADJUSTMENT_ID,
              maxPowerAdjustment
                  .<BaseTLVType>map(
                      (nonOptionalmaxPowerAdjustment) -> new IntType(nonOptionalmaxPowerAdjustment))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MIN_DURATION_ADJUSTMENT_ID,
              minDurationAdjustment
                  .<BaseTLVType>map(
                      (nonOptionalminDurationAdjustment) ->
                          new UIntType(nonOptionalminDurationAdjustment))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              MAX_DURATION_ADJUSTMENT_ID,
              maxDurationAdjustment
                  .<BaseTLVType>map(
                      (nonOptionalmaxDurationAdjustment) ->
                          new UIntType(nonOptionalmaxDurationAdjustment))
                  .orElse(new EmptyType())));
  ...
  public static class DeviceEnergyManagementClusterForecastStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ACTIVE_SLOT_NUMBER_ID,
              activeSlotNumber != null ? new UIntType(activeSlotNumber) : new NullType()));
      ...
      values.add(
          new StructElement(
              EARLIEST_START_TIME_ID,
              earliestStartTime != null
                  ? earliestStartTime
                      .<BaseTLVType>map(
                          (nonOptionalearliestStartTime) ->
                              new UIntType(nonOptionalearliestStartTime))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              latestEndTime
                  .<BaseTLVType>map(
                      (nonOptionallatestEndTime) -> new UIntType(nonOptionallatestEndTime))
                  .orElse(new EmptyType())));
      values.add(new StructElement(IS_PAUSABLE_ID, new BooleanType(isPausable)));
      values.add(
          new StructElement(
              SLOTS_ID,
              ArrayType.generateArrayType(slots, (elementslots) -> elementslots.encodeTlv())));
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              maximumEnergy
                  .<BaseTLVType>map(
                      (nonOptionalmaximumEnergy) -> new IntType(nonOptionalmaximumEnergy))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              LOAD_CONTROL_ID,
              loadControl
                  .<BaseTLVType>map((nonOptionalloadControl) -> new IntType(nonOptionalloadControl))
                  .orElse(new EmptyType())));
  ...
  public static class DeviceEnergyManagementClusterSlotAdjustmentStruct {
    ...
    public DeviceEnergyManagementClusterSlotAdjustmentStruct(
        Integer slotIndex, Optional<Long> nominalPower, Long duration) {
    ...
    public static DeviceEnergyManagementClusterSlotAdjustmentStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
  ...
  public static class EnergyEvseClusterChargingTargetStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TARGET_TIME_MINUTES_PAST_MIDNIGHT_ID, new UIntType(targetTimeMinutesPastMidnight)));
      values.add(
          new StructElement(
              TARGET_SO_C_ID,
              targetSoC
                  .<BaseTLVType>map((nonOptionaltargetSoC) -> new UIntType(nonOptionaltargetSoC))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              ADDED_ENERGY_ID,
              addedEnergy
                  .<BaseTLVType>map((nonOptionaladdedEnergy) -> new IntType(nonOptionaladdedEnergy))
                  .orElse(new EmptyType())));
  ...
  public static class EnergyEvseClusterChargingTargetScheduleStruct {
    ...
    public StructType encodeTlv() {
      ArrayList<StructElement> values = new ArrayList<>();
      values.add(
          new StructElement(DAY_OF_WEEK_FOR_SEQUENCE_ID, new UIntType(dayOfWeekForSequence)));
      values.add(
          new StructElement(
              CHARGING_TARGETS_ID,
              ArrayType.generateArrayType(
                  chargingTargets,
                  (elementchargingTargets) -> elementchargingTargets.encodeTlv())));
  ...
  public static class EnergyPreferenceClusterBalanceStruct {
    ...
    public EnergyPreferenceClusterBalanceStruct(Integer step, Optional<String> label) {
      this.step = step;
      this.label = label;
    }
    ...
    public static EnergyPreferenceClusterBalanceStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyPreferenceClusterBalanceStruct(step, label);
    }
  ...
  public static class EnergyEvseModeClusterModeTagStruct {
    ...
    public EnergyEvseModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static EnergyEvseModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyEvseModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class EnergyEvseModeClusterModeOptionStruct {
    ...
    public static EnergyEvseModeClusterModeOptionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EnergyEvseModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class WaterHeaterModeClusterModeTagStruct {
    ...
    public WaterHeaterModeClusterModeTagStruct(Optional<Integer> mfgCode, Integer value) {
      this.mfgCode = mfgCode;
      this.value = value;
    }
    ...
    public static WaterHeaterModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new WaterHeaterModeClusterModeTagStruct(mfgCode, value);
    }
        ...
        if (element.contextTagNum() == LABEL_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            modeTags =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.WaterHeaterModeClusterModeTagStruct.decodeTlv(
                            elementcastingValue));
          }
        }
      }
      return new WaterHeaterModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class DeviceEnergyManagementModeClusterModeTagStruct {
    ...
    public static DeviceEnergyManagementModeClusterModeTagStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DeviceEnergyManagementModeClusterModeTagStruct(mfgCode, value);
    }
  ...
  public static class DeviceEnergyManagementModeClusterModeOptionStruct {
    ...
    public static DeviceEnergyManagementModeClusterModeOptionStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new DeviceEnergyManagementModeClusterModeOptionStruct(label, mode, modeTags);
    }
  ...
  public static class DoorLockClusterCredentialStruct {
    ...
    public static DoorLockClusterCredentialStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new DoorLockClusterCredentialStruct(credentialType, credentialIndex);
    }
  ...
  public static class ServiceAreaClusterLocationDescriptorStruct {
    ...
    public ServiceAreaClusterLocationDescriptorStruct(
        String locationName, @Nullable Integer floorNumber, @Nullable Integer areaType) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              FLOOR_NUMBER_ID, floorNumber != null ? new IntType(floorNumber) : new NullType()));
      values.add(
          new StructElement(
              AREA_TYPE_ID, areaType != null ? new UIntType(areaType) : new NullType()));
    ...
    public static ServiceAreaClusterLocationDescriptorStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ServiceAreaClusterLocationDescriptorStruct(locationName, floorNumber, areaType);
    }
  ...
  public static class ServiceAreaClusterLocationInfoStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              LOCATION_INFO_ID, locationInfo != null ? locationInfo.encodeTlv() : new NullType()));
      values.add(
          new StructElement(
              LANDMARK_TAG_ID, landmarkTag != null ? new UIntType(landmarkTag) : new NullType()));
      values.add(
          new StructElement(
              POSITION_TAG_ID, positionTag != null ? new UIntType(positionTag) : new NullType()));
      values.add(
          new StructElement(
              SURFACE_TAG_ID, surfaceTag != null ? new UIntType(surfaceTag) : new NullType()));
    ...
    public static ServiceAreaClusterLocationInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == LOCATION_INFO_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            locationInfo =
                ChipStructs.ServiceAreaClusterLocationDescriptorStruct.decodeTlv(castingValue);
          }
      ...
      return new ServiceAreaClusterLocationInfoStruct(
          locationInfo, landmarkTag, positionTag, surfaceTag);
    }
  ...
  public static class ServiceAreaClusterLocationStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(MAP_I_D_ID, mapID != null ? new UIntType(mapID) : new NullType()));
    ...
    public static ServiceAreaClusterLocationStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ServiceAreaClusterLocationStruct(locationID, mapID, locationInfo);
    }
  ...
  public static class ServiceAreaClusterMapStruct {
    ...
    public ServiceAreaClusterMapStruct(Integer mapID, String name) {
      this.mapID = mapID;
      this.name = name;
    }
    ...
    public static ServiceAreaClusterMapStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ServiceAreaClusterMapStruct(mapID, name);
    }
  ...
  public static class ServiceAreaClusterProgressStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TOTAL_OPERATIONAL_TIME_ID,
              totalOperationalTime != null
                  ? totalOperationalTime
                      .<BaseTLVType>map(
                          (nonOptionaltotalOperationalTime) ->
                              new UIntType(nonOptionaltotalOperationalTime))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              estimatedTime != null
                  ? estimatedTime
                      .<BaseTLVType>map(
                          (nonOptionalestimatedTime) -> new UIntType(nonOptionalestimatedTime))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static ServiceAreaClusterProgressStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ServiceAreaClusterProgressStruct(
          locationID, status, totalOperationalTime, estimatedTime);
    }
  ...
  public static class ThermostatClusterScheduleTransitionStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              presetHandle
                  .<BaseTLVType>map(
                      (nonOptionalpresetHandle) -> new ByteArrayType(nonOptionalpresetHandle))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              SYSTEM_MODE_ID,
              systemMode
                  .<BaseTLVType>map((nonOptionalsystemMode) -> new UIntType(nonOptionalsystemMode))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              COOLING_SETPOINT_ID,
              coolingSetpoint
                  .<BaseTLVType>map(
                      (nonOptionalcoolingSetpoint) -> new IntType(nonOptionalcoolingSetpoint))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              HEATING_SETPOINT_ID,
              heatingSetpoint
                  .<BaseTLVType>map(
                      (nonOptionalheatingSetpoint) -> new IntType(nonOptionalheatingSetpoint))
                  .orElse(new EmptyType())));
    ...
    public static ThermostatClusterScheduleTransitionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThermostatClusterScheduleTransitionStruct(
          dayOfWeek, transitionTime, presetHandle, systemMode, coolingSetpoint, heatingSetpoint);
    }
  ...
  public static class ThermostatClusterScheduleStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              SCHEDULE_HANDLE_ID,
              scheduleHandle != null ? new ByteArrayType(scheduleHandle) : new NullType()));
      ...
      values.add(
          new StructElement(
              ...
              builtIn != null
                  ? builtIn
                      .<BaseTLVType>map((nonOptionalbuiltIn) -> new BooleanType(nonOptionalbuiltIn))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static ThermostatClusterScheduleStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThermostatClusterScheduleStruct(
          scheduleHandle, systemMode, name, presetHandle, transitions, builtIn);
    }
  ...
  public static class ThermostatClusterPresetStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              PRESET_HANDLE_ID,
              presetHandle != null ? new ByteArrayType(presetHandle) : new NullType()));
      ...
      values.add(
          new StructElement(
              BUILT_IN_ID, builtIn != null ? new BooleanType(builtIn) : new NullType()));
    ...
    public static ThermostatClusterPresetStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThermostatClusterPresetStruct(
          presetHandle, presetScenario, name, coolingSetpoint, heatingSetpoint, builtIn);
    }
  ...
  public static class ThermostatClusterPresetTypeStruct {
    ...
    public ThermostatClusterPresetTypeStruct(
        Integer presetScenario, Integer numberOfPresets, Integer presetTypeFeatures) {
      this.presetScenario = presetScenario;
    ...
    public static ThermostatClusterPresetTypeStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThermostatClusterPresetTypeStruct(
          presetScenario, numberOfPresets, presetTypeFeatures);
    }
  ...
  public static class ThermostatClusterScheduleTypeStruct {
    ...
    public ThermostatClusterScheduleTypeStruct(
        Integer systemMode, Integer numberOfSchedules, Integer scheduleTypeFeatures) {
      this.systemMode = systemMode;
    ...
    public static ThermostatClusterScheduleTypeStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThermostatClusterScheduleTypeStruct(
          systemMode, numberOfSchedules, scheduleTypeFeatures);
    }
  ...
  public static class ThermostatClusterWeeklyScheduleTransitionStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              HEAT_SETPOINT_ID, heatSetpoint != null ? new IntType(heatSetpoint) : new NullType()));
      values.add(
          new StructElement(
              COOL_SETPOINT_ID, coolSetpoint != null ? new IntType(coolSetpoint) : new NullType()));
    ...
    public static ThermostatClusterWeeklyScheduleTransitionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThermostatClusterWeeklyScheduleTransitionStruct(
          transitionTime, heatSetpoint, coolSetpoint);
    }
  ...
  public static class OccupancySensingClusterHoldTimeLimitsStruct {
    ...
    public OccupancySensingClusterHoldTimeLimitsStruct(
        Integer holdTimeMin, Integer holdTimeMax, Integer holdTimeDefault) {
    ...
    public static OccupancySensingClusterHoldTimeLimitsStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new OccupancySensingClusterHoldTimeLimitsStruct(
          holdTimeMin, holdTimeMax, holdTimeDefault);
    }
  ...
  public static class ThreadNetworkDirectoryClusterThreadNetworkStruct {
    ...
    public ThreadNetworkDirectoryClusterThreadNetworkStruct(
        byte[] extendedPanID, String networkName, Integer channel, Long activeTimestamp) {
      this.extendedPanID = extendedPanID;
      this.networkName = networkName;
      this.channel = channel;
    ...
    public static ThreadNetworkDirectoryClusterThreadNetworkStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ThreadNetworkDirectoryClusterThreadNetworkStruct(
          extendedPanID, networkName, channel, activeTimestamp);
    }
  ...
  public static class ChannelClusterProgramCastStruct {
    ...
    public ChannelClusterProgramCastStruct(String name, String role) {
      this.name = name;
      this.role = role;
    }
    ...
    public static ChannelClusterProgramCastStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ChannelClusterProgramCastStruct(name, role);
    }
  ...
  public static class ChannelClusterProgramCategoryStruct {
    ...
    public ChannelClusterProgramCategoryStruct(String category, Optional<String> subCategory) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              subCategory
                  .<BaseTLVType>map(
                      (nonOptionalsubCategory) -> new StringType(nonOptionalsubCategory))
                  .orElse(new EmptyType())));
    ...
    public static ChannelClusterProgramCategoryStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ChannelClusterProgramCategoryStruct(category, subCategory);
    }
  ...
  public static class ChannelClusterSeriesInfoStruct {
    ...
    public ChannelClusterSeriesInfoStruct(String season, String episode) {
      this.season = season;
    ...
    public static ChannelClusterSeriesInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ChannelClusterSeriesInfoStruct(season, episode);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              CALL_SIGN_ID,
              callSign
                  .<BaseTLVType>map((nonOptionalcallSign) -> new StringType(nonOptionalcallSign))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              AFFILIATE_CALL_SIGN_ID,
              affiliateCallSign
                  .<BaseTLVType>map(
                      (nonOptionalaffiliateCallSign) ->
                          new StringType(nonOptionalaffiliateCallSign))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              IDENTIFIER_ID,
              identifier
                  .<BaseTLVType>map(
                      (nonOptionalidentifier) -> new StringType(nonOptionalidentifier))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              TYPE_ID,
              type.<BaseTLVType>map((nonOptionaltype) -> new UIntType(nonOptionaltype))
                  .orElse(new EmptyType())));
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              SUBTITLE_ID,
              subtitle
                  .<BaseTLVType>map((nonOptionalsubtitle) -> new StringType(nonOptionalsubtitle))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              DESCRIPTION_ID,
              description
                  .<BaseTLVType>map(
                      (nonOptionaldescription) -> new StringType(nonOptionaldescription))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              AUDIO_LANGUAGES_ID,
              audioLanguages
                  .<BaseTLVType>map(
                      (nonOptionalaudioLanguages) ->
                          ArrayType.generateArrayType(
                              nonOptionalaudioLanguages,
                              (elementnonOptionalaudioLanguages) ->
                                  new StringType(elementnonOptionalaudioLanguages)))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              RATINGS_ID,
              ratings
                  .<BaseTLVType>map(
                      (nonOptionalratings) ->
                          ArrayType.generateArrayType(
                              nonOptionalratings,
                              (elementnonOptionalratings) ->
                                  new StringType(elementnonOptionalratings)))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              THUMBNAIL_URL_ID,
              thumbnailUrl
                  .<BaseTLVType>map(
                      (nonOptionalthumbnailUrl) -> new StringType(nonOptionalthumbnailUrl))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              POSTER_ART_URL_ID,
              posterArtUrl
                  .<BaseTLVType>map(
                      (nonOptionalposterArtUrl) -> new StringType(nonOptionalposterArtUrl))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              DVBI_URL_ID,
              dvbiUrl
                  .<BaseTLVType>map((nonOptionaldvbiUrl) -> new StringType(nonOptionaldvbiUrl))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              RELEASE_DATE_ID,
              releaseDate
                  .<BaseTLVType>map(
                      (nonOptionalreleaseDate) -> new StringType(nonOptionalreleaseDate))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              PARENTAL_GUIDANCE_TEXT_ID,
              parentalGuidanceText
                  .<BaseTLVType>map(
                      (nonOptionalparentalGuidanceText) ->
                          new StringType(nonOptionalparentalGuidanceText))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              RECORDING_FLAG_ID,
              recordingFlag
                  .<BaseTLVType>map(
                      (nonOptionalrecordingFlag) -> new UIntType(nonOptionalrecordingFlag))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              SERIES_INFO_ID,
              seriesInfo != null
                  ? seriesInfo
                      .<BaseTLVType>map(
                          (nonOptionalseriesInfo) -> nonOptionalseriesInfo.encodeTlv())
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              categoryList
                  .<BaseTLVType>map(
                      (nonOptionalcategoryList) ->
                          ArrayType.generateArrayType(
                              nonOptionalcategoryList,
                              (elementnonOptionalcategoryList) ->
                                  elementnonOptionalcategoryList.encodeTlv()))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              CAST_LIST_ID,
              castList
                  .<BaseTLVType>map(
                      (nonOptionalcastList) ->
                          ArrayType.generateArrayType(
                              nonOptionalcastList,
                              (elementnonOptionalcastList) ->
                                  elementnonOptionalcastList.encodeTlv()))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              EXTERNAL_I_D_LIST_ID,
              externalIDList
                  .<BaseTLVType>map(
                      (nonOptionalexternalIDList) ->
                          ArrayType.generateArrayType(
                              nonOptionalexternalIDList,
                              (elementnonOptionalexternalIDList) ->
                                  elementnonOptionalexternalIDList.encodeTlv()))
                  .orElse(new EmptyType())));
        ...
        if (element.contextTagNum() == IDENTIFIER_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            audioLanguages =
                Optional.of(
                    castingValue.map(
                        (elementcastingValue) -> elementcastingValue.value(String.class)));
          }
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            seriesInfo =
                Optional.of(ChipStructs.ChannelClusterSeriesInfoStruct.decodeTlv(castingValue));
          }
  ...
  public static class ChannelClusterPageTokenStruct {
    ...
    public ChannelClusterPageTokenStruct(
        Optional<Integer> limit, Optional<String> after, Optional<String> before) {
      this.limit = limit;
      this.after = after;
      this.before = before;
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              LIMIT_ID,
              limit
                  .<BaseTLVType>map((nonOptionallimit) -> new UIntType(nonOptionallimit))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              AFTER_ID,
              after
                  .<BaseTLVType>map((nonOptionalafter) -> new StringType(nonOptionalafter))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              BEFORE_ID,
              before
                  .<BaseTLVType>map((nonOptionalbefore) -> new StringType(nonOptionalbefore))
                  .orElse(new EmptyType())));
    ...
    public static ChannelClusterPageTokenStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ChannelClusterPageTokenStruct(limit, after, before);
    }
  ...
  public static class ChannelClusterChannelPagingStruct {
      ...
      values.add(
          new StructElement(
              ...
              previousToken != null
                  ? previousToken
                      .<BaseTLVType>map(
                          (nonOptionalpreviousToken) -> nonOptionalpreviousToken.encodeTlv())
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              nextToken != null
                  ? nextToken
                      .<BaseTLVType>map((nonOptionalnextToken) -> nonOptionalnextToken.encodeTlv())
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static ChannelClusterChannelPagingStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == PREVIOUS_TOKEN_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            previousToken =
                Optional.of(ChipStructs.ChannelClusterPageTokenStruct.decodeTlv(castingValue));
          }
      ...
      return new ChannelClusterChannelPagingStruct(previousToken, nextToken);
    }
  ...
  public static class ChannelClusterAdditionalInfoStruct {
    ...
    public ChannelClusterAdditionalInfoStruct(String name, String value) {
      this.name = name;
      this.value = value;
    }
    ...
    public static ChannelClusterAdditionalInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ChannelClusterAdditionalInfoStruct(name, value);
    }
  ...
  public static class ChannelClusterLineupInfoStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              lineupName
                  .<BaseTLVType>map(
                      (nonOptionallineupName) -> new StringType(nonOptionallineupName))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              POSTAL_CODE_ID,
              postalCode
                  .<BaseTLVType>map(
                      (nonOptionalpostalCode) -> new StringType(nonOptionalpostalCode))
                  .orElse(new EmptyType())));
    ...
    public static ChannelClusterLineupInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ChannelClusterLineupInfoStruct(
          operatorName, lineupName, postalCode, lineupInfoType);
    }
  ...
  public static class TargetNavigatorClusterTargetInfoStruct {
    ...
    public static TargetNavigatorClusterTargetInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new TargetNavigatorClusterTargetInfoStruct(identifier, name);
    }
  ...
  public static class MediaPlaybackClusterTrackAttributesStruct {
    ...
    public MediaPlaybackClusterTrackAttributesStruct(
        String languageCode, @Nullable Optional<String> displayName) {
      ...
      values.add(
          new StructElement(
              ...
              displayName != null
                  ? displayName
                      .<BaseTLVType>map(
                          (nonOptionaldisplayName) -> new StringType(nonOptionaldisplayName))
                      .orElse(new EmptyType())
                  : new NullType()));
    ...
    public static MediaPlaybackClusterTrackAttributesStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MediaPlaybackClusterTrackAttributesStruct(languageCode, displayName);
    }
  ...
  public static class MediaPlaybackClusterTrackStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              TRACK_ATTRIBUTES_ID,
              trackAttributes != null ? trackAttributes.encodeTlv() : new NullType()));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == ID_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            trackAttributes =
                ChipStructs.MediaPlaybackClusterTrackAttributesStruct.decodeTlv(castingValue);
          }
        }
      }
      return new MediaPlaybackClusterTrackStruct(id, trackAttributes);
    }
  ...
  public static class MediaPlaybackClusterPlaybackPositionStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              POSITION_ID, position != null ? new UIntType(position) : new NullType()));
    ...
    public static MediaPlaybackClusterPlaybackPositionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MediaPlaybackClusterPlaybackPositionStruct(updatedAt, position);
    }
  ...
  public static class MediaInputClusterInputInfoStruct {
    ...
    public static MediaInputClusterInputInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new MediaInputClusterInputInfoStruct(index, inputType, name, description);
    }
  ...
  public static class ContentLauncherClusterDimensionStruct {
    ...
    public static ContentLauncherClusterDimensionStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ContentLauncherClusterDimensionStruct(width, height, metric);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              characteristics
                  .<BaseTLVType>map(
                      (nonOptionalcharacteristics) ->
                          ArrayType.generateArrayType(
                              nonOptionalcharacteristics,
                              (elementnonOptionalcharacteristics) ->
                                  new UIntType(elementnonOptionalcharacteristics)))
                  .orElse(new EmptyType())));
        ...
        if (element.contextTagNum() == LANGUAGE_CODE_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            characteristics =
                Optional.of(
                    castingValue.map(
                        (elementcastingValue) -> elementcastingValue.value(Integer.class)));
          }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              audioTracks
                  .<BaseTLVType>map(
                      (nonOptionalaudioTracks) ->
                          ArrayType.generateArrayType(
                              nonOptionalaudioTracks,
                              (elementnonOptionalaudioTracks) ->
                                  elementnonOptionalaudioTracks.encodeTlv()))
                  .orElse(new EmptyType())));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == PLAYBACK_POSITION_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            textTrack =
                ChipStructs.ContentLauncherClusterTrackPreferenceStruct.decodeTlv(castingValue);
          }
  ...
  public static class ContentLauncherClusterAdditionalInfoStruct {
    ...
    public static ContentLauncherClusterAdditionalInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ContentLauncherClusterAdditionalInfoStruct(name, value);
    }
  ...
  public static class ContentLauncherClusterParameterStruct {
    ...
    public static ContentLauncherClusterParameterStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ContentLauncherClusterParameterStruct(type, value, externalIDList);
    }
  ...
  public static class ContentLauncherClusterContentSearchStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              PARAMETER_LIST_ID,
              ArrayType.generateArrayType(
                  parameterList, (elementparameterList) -> elementparameterList.encodeTlv())));
    ...
    public static ContentLauncherClusterContentSearchStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ContentLauncherClusterContentSearchStruct(parameterList);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              IMAGE_U_R_L_ID,
              imageURL
                  .<BaseTLVType>map((nonOptionalimageURL) -> new StringType(nonOptionalimageURL))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              COLOR_ID,
              color
                  .<BaseTLVType>map((nonOptionalcolor) -> new StringType(nonOptionalcolor))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              SIZE_ID,
              size.<BaseTLVType>map((nonOptionalsize) -> nonOptionalsize.encodeTlv())
                  .orElse(new EmptyType())));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == IMAGE_U_R_L_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            size =
                Optional.of(
                    ChipStructs.ContentLauncherClusterDimensionStruct.decodeTlv(castingValue));
          }
        }
      }
      return new ContentLauncherClusterStyleInformationStruct(imageURL, color, size);
    }
  ...
  public static class ContentLauncherClusterBrandingInformationStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              BACKGROUND_ID,
              background
                  .<BaseTLVType>map((nonOptionalbackground) -> nonOptionalbackground.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              LOGO_ID,
              logo.<BaseTLVType>map((nonOptionallogo) -> nonOptionallogo.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              PROGRESS_BAR_ID,
              progressBar
                  .<BaseTLVType>map((nonOptionalprogressBar) -> nonOptionalprogressBar.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              SPLASH_ID,
              splash
                  .<BaseTLVType>map((nonOptionalsplash) -> nonOptionalsplash.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              WATER_MARK_ID,
              waterMark
                  .<BaseTLVType>map((nonOptionalwaterMark) -> nonOptionalwaterMark.encodeTlv())
                  .orElse(new EmptyType())));
    ...
    public static ContentLauncherClusterBrandingInformationStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == PROVIDER_NAME_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            background =
                Optional.of(
                    ChipStructs.ContentLauncherClusterStyleInformationStruct.decodeTlv(
                        castingValue));
          }
      ...
      return new ContentLauncherClusterBrandingInformationStruct(
          providerName, background, logo, progressBar, splash, waterMark);
    }
  ...
  public static class AudioOutputClusterOutputInfoStruct {
    ...
    public static AudioOutputClusterOutputInfoStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new AudioOutputClusterOutputInfoStruct(index, outputType, name);
    }
  ...
  public static class ApplicationLauncherClusterApplicationStruct {
    ...
    public static ApplicationLauncherClusterApplicationStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ApplicationLauncherClusterApplicationStruct(catalogVendorID, applicationID);
    }
  ...
  public static class ApplicationLauncherClusterApplicationEPStruct {
    ...
    public static ApplicationLauncherClusterApplicationEPStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == APPLICATION_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            application =
                ChipStructs.ApplicationLauncherClusterApplicationStruct.decodeTlv(castingValue);
          }
        } else if (element.contextTagNum() == ENDPOINT_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.UInt) {
            UIntType castingValue = element.value(UIntType.class);
      ...
      return new ApplicationLauncherClusterApplicationEPStruct(application, endpoint);
    }
  ...
  public static class ApplicationBasicClusterApplicationStruct {
    ...
    public static ApplicationBasicClusterApplicationStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ApplicationBasicClusterApplicationStruct(catalogVendorID, applicationID);
    }
  ...
  public static class ContentControlClusterRatingNameStruct {
    ...
    public ContentControlClusterRatingNameStruct(
        String ratingName, Optional<String> ratingNameDesc) {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              ratingNameDesc
                  .<BaseTLVType>map(
                      (nonOptionalratingNameDesc) -> new StringType(nonOptionalratingNameDesc))
                  .orElse(new EmptyType())));
    ...
    public static ContentControlClusterRatingNameStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new ContentControlClusterRatingNameStruct(ratingName, ratingNameDesc);
    }
  ...
  public static class EcosystemInformationClusterLocationDescriptorStruct {
    ...
    public static EcosystemInformationClusterLocationDescriptorStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      return new EcosystemInformationClusterLocationDescriptorStruct(
          locationName, floorNumber, areaType);
    }
  ...
  public static class EcosystemInformationClusterEcosystemLocationStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              LOCATION_DESCRIPTOR_LAST_EDIT_ID, new UIntType(locationDescriptorLastEdit)));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));

      return new StructType(values);
    }

    public static EcosystemInformationClusterEcosystemLocationStruct decodeTlv(
        BaseTLVType tlvValue) {
      if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
        return null;
      }
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == UNIQUE_LOCATION_I_D_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            locationDescriptor =
                ChipStructs.EcosystemInformationClusterLocationDescriptorStruct.decodeTlv(
                    castingValue);
          }
      ...
      return new EcosystemInformationClusterEcosystemLocationStruct(
          uniqueLocationID, locationDescriptor, locationDescriptorLastEdit, fabricIndex);
    }
  ...
  public static class EcosystemInformationClusterDeviceTypeStruct {
    ...
    public EcosystemInformationClusterDeviceTypeStruct(Long deviceType, Integer revision) {
      this.deviceType = deviceType;
      this.revision = revision;
    }
    ...
    public static EcosystemInformationClusterDeviceTypeStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new EcosystemInformationClusterDeviceTypeStruct(deviceType, revision);
    }
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              ...
              deviceName
                  .<BaseTLVType>map(
                      (nonOptionaldeviceName) -> new StringType(nonOptionaldeviceName))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              DEVICE_NAME_LAST_EDIT_ID,
              deviceNameLastEdit
                  .<BaseTLVType>map(
                      (nonOptionaldeviceNameLastEdit) ->
                          new UIntType(nonOptionaldeviceNameLastEdit))
                  .orElse(new EmptyType())));
      ...
      values.add(
          new StructElement(
              DEVICE_TYPES_ID,
              ArrayType.generateArrayType(
                  deviceTypes, (elementdeviceTypes) -> elementdeviceTypes.encodeTlv())));
      values.add(
          new StructElement(
              UNIQUE_LOCATION_I_DS_ID,
              ArrayType.generateArrayType(
                  uniqueLocationIDs,
                  (elementuniqueLocationIDs) -> new StringType(elementuniqueLocationIDs))));
      values.add(
          new StructElement(
              UNIQUE_LOCATION_I_DS_LAST_EDIT_ID, new UIntType(uniqueLocationIDsLastEdit)));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));
        ...
        if (element.contextTagNum() == DEVICE_NAME_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            deviceTypes =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.EcosystemInformationClusterDeviceTypeStruct.decodeTlv(
                            elementcastingValue));
          }
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ArrayType castingValue = element.value(ArrayType.class);
            uniqueLocationIDs =
                castingValue.map((elementcastingValue) -> elementcastingValue.value(String.class));
          }
  ...
  public static class UnitTestingClusterSimpleStruct {
    ...
    public static UnitTestingClusterSimpleStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UnitTestingClusterSimpleStruct(a, b, c, d, e, f, g, h);
    }
  ...
  public static class UnitTestingClusterTestFabricScoped {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              OPTIONAL_FABRIC_SENSITIVE_INT8U_ID,
              optionalFabricSensitiveInt8u
                  .<BaseTLVType>map(
                      (nonOptionaloptionalFabricSensitiveInt8u) ->
                          new UIntType(nonOptionaloptionalFabricSensitiveInt8u))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NULLABLE_FABRIC_SENSITIVE_INT8U_ID,
              nullableFabricSensitiveInt8u != null
                  ? new UIntType(nullableFabricSensitiveInt8u)
                  : new NullType()));
      values.add(
          new StructElement(
              NULLABLE_OPTIONAL_FABRIC_SENSITIVE_INT8U_ID,
              nullableOptionalFabricSensitiveInt8u != null
                  ? nullableOptionalFabricSensitiveInt8u
                      .<BaseTLVType>map(
                          (nonOptionalnullableOptionalFabricSensitiveInt8u) ->
                              new UIntType(nonOptionalnullableOptionalFabricSensitiveInt8u))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              FABRIC_SENSITIVE_CHAR_STRING_ID, new StringType(fabricSensitiveCharString)));
      values.add(new StructElement(FABRIC_SENSITIVE_STRUCT_ID, fabricSensitiveStruct.encodeTlv()));
      values.add(
          new StructElement(
              FABRIC_SENSITIVE_INT8U_LIST_ID,
              ArrayType.generateArrayType(
                  fabricSensitiveInt8uList,
                  (elementfabricSensitiveInt8uList) ->
                      new UIntType(elementfabricSensitiveInt8uList))));
      values.add(new StructElement(FABRIC_INDEX_ID, new UIntType(fabricIndex)));
        ...
        if (element.contextTagNum() == FABRIC_SENSITIVE_INT8U_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            ...
            fabricSensitiveStruct =
                ChipStructs.UnitTestingClusterSimpleStruct.decodeTlv(castingValue);
          }
  ...
  public static class UnitTestingClusterNullablesAndOptionalsStruct {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              NULLABLE_INT_ID, nullableInt != null ? new UIntType(nullableInt) : new NullType()));
      values.add(
          new StructElement(
              OPTIONAL_INT_ID,
              optionalInt
                  .<BaseTLVType>map(
                      (nonOptionaloptionalInt) -> new UIntType(nonOptionaloptionalInt))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NULLABLE_OPTIONAL_INT_ID,
              nullableOptionalInt != null
                  ? nullableOptionalInt
                      .<BaseTLVType>map(
                          (nonOptionalnullableOptionalInt) ->
                              new UIntType(nonOptionalnullableOptionalInt))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              NULLABLE_STRING_ID,
              nullableString != null ? new StringType(nullableString) : new NullType()));
      values.add(
          new StructElement(
              OPTIONAL_STRING_ID,
              optionalString
                  .<BaseTLVType>map(
                      (nonOptionaloptionalString) -> new StringType(nonOptionaloptionalString))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NULLABLE_OPTIONAL_STRING_ID,
              nullableOptionalString != null
                  ? nullableOptionalString
                      .<BaseTLVType>map(
                          (nonOptionalnullableOptionalString) ->
                              new StringType(nonOptionalnullableOptionalString))
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              NULLABLE_STRUCT_ID,
              nullableStruct != null ? nullableStruct.encodeTlv() : new NullType()));
      values.add(
          new StructElement(
              OPTIONAL_STRUCT_ID,
              optionalStruct
                  .<BaseTLVType>map(
                      (nonOptionaloptionalStruct) -> nonOptionaloptionalStruct.encodeTlv())
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NULLABLE_OPTIONAL_STRUCT_ID,
              nullableOptionalStruct != null
                  ? nullableOptionalStruct
                      .<BaseTLVType>map(
                          (nonOptionalnullableOptionalStruct) ->
                              nonOptionalnullableOptionalStruct.encodeTlv())
                      .orElse(new EmptyType())
                  : new NullType()));
      values.add(
          new StructElement(
              ...
              nullableList != null
                  ? ArrayType.generateArrayType(
                      nullableList, (elementnullableList) -> new UIntType(elementnullableList))
                  : new NullType()));
      values.add(
          new StructElement(
              OPTIONAL_LIST_ID,
              optionalList
                  .<BaseTLVType>map(
                      (nonOptionaloptionalList) ->
                          ArrayType.generateArrayType(
                              nonOptionaloptionalList,
                              (elementnonOptionaloptionalList) ->
                                  new UIntType(elementnonOptionaloptionalList)))
                  .orElse(new EmptyType())));
      values.add(
          new StructElement(
              NULLABLE_OPTIONAL_LIST_ID,
              nullableOptionalList != null
                  ? nullableOptionalList
                      .<BaseTLVType>map(
                          (nonOptionalnullableOptionalList) ->
                              ArrayType.generateArrayType(
                                  nonOptionalnullableOptionalList,
                                  (elementnonOptionalnullableOptionalList) ->
                                      new UIntType(elementnonOptionalnullableOptionalList)))
                      .orElse(new EmptyType())
                  : new NullType()));
      ...
      for (StructElement element : ((StructType) tlvValue).value()) {
        if (element.contextTagNum() == NULLABLE_INT_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
            StructType castingValue = element.value(StructType.class);
            optionalStruct =
                Optional.of(ChipStructs.UnitTestingClusterSimpleStruct.decodeTlv(castingValue));
          }
  ...
  public static class UnitTestingClusterNestedStruct {
    ...
    public static UnitTestingClusterNestedStruct decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UnitTestingClusterNestedStruct(a, b, c);
    }
  ...
  public static class UnitTestingClusterNestedStructList {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              D_ID, ArrayType.generateArrayType(d, (elementd) -> elementd.encodeTlv())));
      values.add(
          new StructElement(
              E_ID, ArrayType.generateArrayType(e, (elemente) -> new UIntType(elemente))));
      values.add(
          new StructElement(
              F_ID, ArrayType.generateArrayType(f, (elementf) -> new ByteArrayType(elementf))));
      values.add(
          new StructElement(
              G_ID, ArrayType.generateArrayType(g, (elementg) -> new UIntType(elementg))));
    ...
    public static UnitTestingClusterNestedStructList decodeTlv(BaseTLVType tlvValue) {
        ...
        if (element.contextTagNum() == A_ID) {
          ...
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ...
            d =
                castingValue.map(
                    (elementcastingValue) ->
                        ChipStructs.UnitTestingClusterSimpleStruct.decodeTlv(elementcastingValue));
          }
        } else if (element.contextTagNum() == E_ID) {
          if (element.value(BaseTLVType.class).type() == TLVType.Array) {
            ArrayType castingValue = element.value(ArrayType.class);
      ...
      return new UnitTestingClusterNestedStructList(a, b, c, d, e, f, g);
    }
  ...
  public static class UnitTestingClusterDoubleNestedStructList {
    ...
    public StructType encodeTlv() {
      ...
      values.add(
          new StructElement(
              A_ID, ArrayType.generateArrayType(a, (elementa) -> elementa.encodeTlv())));
    ...
    public static UnitTestingClusterDoubleNestedStructList decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UnitTestingClusterDoubleNestedStructList(a);
    }
  ...
  public static class UnitTestingClusterTestListStructOctet {
    ...
    public static UnitTestingClusterTestListStructOctet decodeTlv(BaseTLVType tlvValue) {
      ...
      return new UnitTestingClusterTestListStructOctet(member1, member2);
    }

...
public class ClusterIDMapping {
  ...
  public static class NetworkCommissioning implements BaseCluster {
    ...
    public enum QueryIdentityCommandField {
      KeyIdentifier(0),
      PossessionNonce(1),
      ;
      private final int id;
  ...
  public static class GeneralDiagnostics implements BaseCluster {
    ...
    public enum PayloadTestRequestCommandField {
      EnableKey(0),
      Value(1),
      Count(2),
      ;
  ...
  public static class JointFabricPki implements BaseCluster {
    ...
    public enum JointFabricRequestCommandField {
      FabricIndex(0),
      ;
      private final int id;
    ...
    public enum SignNOCIssuerResponseCommandField {
      StatusCode(0),
      NOCIssuerCert(1),
      NodeId(2),
      FabricId(3),
  ...
  public static class IcdManagement implements BaseCluster {
    ...
    public enum StayActiveRequestCommandField {
      StayActiveDuration(0),
      ;
      private final int id;
  ...
  public static class Timer implements BaseCluster {
    ...
    public enum SetTimerCommandField {
      NewTime(0),
      ;
      private final int id;
    ...
    public enum AddTimeCommandField {
      AdditionalTime(0),
      ;
      private final int id;
    ...
    public enum ReduceTimeCommandField {
      TimeReduction(0),
      ;
      private final int id;
  ...
  public static class MicrowaveOvenControl implements BaseCluster {
    ...
    public enum SetCookingParametersCommandField {
      CookMode(0),
      CookTime(1),
      PowerSetting(2),
      WattSettingIndex(3),
    ...
    public enum AddMoreTimeCommandField {
      TimeToAdd(0),
      ;
      private final int id;
  ...
  public static class BooleanStateConfiguration implements BaseCluster {
    ...
    public enum SuppressAlarmCommandField {
      AlarmsToSuppress(0),
      ;
      private final int id;
    ...
    public enum EnableDisableAlarmCommandField {
  ...
  public static class DemandResponseLoadControl implements BaseCluster {
    ...
    public enum RegisterLoadControlProgramRequestCommandField {
      LoadControlProgram(0),
      ;
      private final int id;
      ...
      public static RegisterLoadControlProgramRequestCommandField value(int id)
          throws NoSuchFieldError {
        for (RegisterLoadControlProgramRequestCommandField field :
            RegisterLoadControlProgramRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum UnregisterLoadControlProgramRequestCommandField {
      LoadControlProgramID(0),
      ;
      private final int id;
      ...
      public static UnregisterLoadControlProgramRequestCommandField value(int id)
          throws NoSuchFieldError {
        for (UnregisterLoadControlProgramRequestCommandField field :
            UnregisterLoadControlProgramRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum AddLoadControlEventRequestCommandField {
      Event(0),
      ;
      private final int id;
      ...
      public static AddLoadControlEventRequestCommandField value(int id) throws NoSuchFieldError {
        for (AddLoadControlEventRequestCommandField field :
            AddLoadControlEventRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum RemoveLoadControlEventRequestCommandField {
      EventID(0),
      CancelControl(1),
      ;
      private final int id;
      ...
      public static RemoveLoadControlEventRequestCommandField value(int id)
          throws NoSuchFieldError {
        for (RemoveLoadControlEventRequestCommandField field :
            RemoveLoadControlEventRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
  ...
  public static class Messages implements BaseCluster {
    ...
    public enum PresentMessagesRequestCommandField {
      MessageID(0),
      Priority(1),
      MessageControl(2),
      StartTime(3),
      ...
      public static PresentMessagesRequestCommandField value(int id) throws NoSuchFieldError {
        for (PresentMessagesRequestCommandField field :
            PresentMessagesRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum CancelMessagesRequestCommandField {
      MessageIDs(0),
      ;
      private final int id;
  ...
  public static class DeviceEnergyManagement implements BaseCluster {
    ...
    public enum PowerAdjustRequestCommandField {
      Power(0),
      Duration(1),
      Cause(2),
      ;
    ...
    public enum StartTimeAdjustRequestCommandField {
      ...
      public static StartTimeAdjustRequestCommandField value(int id) throws NoSuchFieldError {
        for (StartTimeAdjustRequestCommandField field :
            StartTimeAdjustRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum PauseRequestCommandField {
      Duration(0),
      Cause(1),
      ;
      private final int id;
    ...
    public enum ModifyForecastRequestCommandField {
      ForecastID(0),
      SlotAdjustments(1),
      Cause(2),
      ;
    ...
    public enum RequestConstraintBasedForecastCommandField {
      Constraints(0),
      Cause(1),
      ;
      private final int id;
      ...
      public static RequestConstraintBasedForecastCommandField value(int id)
          throws NoSuchFieldError {
        for (RequestConstraintBasedForecastCommandField field :
            RequestConstraintBasedForecastCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
  ...
  public static class EnergyEvse implements BaseCluster {
    ...
    public enum EnableChargingCommandField {
      ChargingEnabledUntil(0),
      MinimumChargeCurrent(1),
      MaximumChargeCurrent(2),
      ;
      private final int id;
    ...
    public enum EnableDischargingCommandField {
      DischargingEnabledUntil(0),
      MaximumDischargeCurrent(1),
      ;
      private final int id;
    ...
    public enum SetTargetsCommandField {
      ChargingTargetSchedules(0),
      ;
      private final int id;
  ...
  public static class DoorLock implements BaseCluster {
    ...
    public enum SetAliroReaderConfigCommandField {
      SigningKey(0),
      VerificationKey(1),
      GroupIdentifier(2),
      GroupResolvingKey(3),
  ...
  public static class ServiceArea implements BaseCluster {
    ...
    public enum SelectLocationsCommandField {
      NewLocations(0),
      ;
      private final int id;
  ...
  public static class Thermostat implements BaseCluster {
    ...
    public enum SetActiveScheduleRequestCommandField {
      ScheduleHandle(0),
      ;
      private final int id;
      ...
      public static SetActiveScheduleRequestCommandField value(int id) throws NoSuchFieldError {
        for (SetActiveScheduleRequestCommandField field :
            SetActiveScheduleRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum SetActivePresetRequestCommandField {
      PresetHandle(0),
      ;
      private final int id;
      ...
      public static SetActivePresetRequestCommandField value(int id) throws NoSuchFieldError {
        for (SetActivePresetRequestCommandField field :
            SetActivePresetRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum StartPresetsSchedulesEditRequestCommandField {
      TimeoutSeconds(0),
      ;
      private final int id;
      ...
      public static StartPresetsSchedulesEditRequestCommandField value(int id)
          throws NoSuchFieldError {
        for (StartPresetsSchedulesEditRequestCommandField field :
            StartPresetsSchedulesEditRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum SetTemperatureSetpointHoldPolicyCommandField {
      TemperatureSetpointHoldPolicy(0),
      ;
      private final int id;
      ...
      public static SetTemperatureSetpointHoldPolicyCommandField value(int id)
          throws NoSuchFieldError {
        for (SetTemperatureSetpointHoldPolicyCommandField field :
            SetTemperatureSetpointHoldPolicyCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
  ...
  public static class ThreadBorderRouterManagement implements BaseCluster {
    ...
    public enum SetActiveDatasetRequestCommandField {
      ActiveDataset(0),
      Breadcrumb(1),
      ;
      private final int id;
      ...
      public static SetActiveDatasetRequestCommandField value(int id) throws NoSuchFieldError {
        for (SetActiveDatasetRequestCommandField field :
            SetActiveDatasetRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum SetPendingDatasetRequestCommandField {
      PendingDataset(0),
      ;
      private final int id;
      ...
      public static SetPendingDatasetRequestCommandField value(int id) throws NoSuchFieldError {
        for (SetPendingDatasetRequestCommandField field :
            SetPendingDatasetRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
  ...
  public static class ThreadNetworkDirectory implements BaseCluster {
    ...
    public enum AddNetworkCommandField {
      OperationalDataset(0),
      ;
      private final int id;
    ...
    public enum GetOperationalDatasetCommandField {
      ExtendedPanID(0),
      ;
      private final int id;
  ...
  public static class Channel implements BaseCluster {
    ...
    public enum GetProgramGuideCommandField {
      StartTime(0),
      EndTime(1),
      ChannelList(2),
      PageToken(3),
    ...
    public enum RecordProgramCommandField {
      ProgramIdentifier(0),
      ShouldRecordSeries(1),
      ExternalIDList(2),
      Data(3),
      ;
      private final int id;
    ...
    public enum CancelRecordProgramCommandField {
      ProgramIdentifier(0),
      ShouldRecordSeries(1),
      ExternalIDList(2),
      Data(3),
  ...
  public static class MediaPlayback implements BaseCluster {
    ...
    public enum RewindCommandField {
      AudioAdvanceUnmuted(0),
      ;
      private final int id;
    ...
    public enum FastForwardCommandField {
      AudioAdvanceUnmuted(0),
      ;
      private final int id;
    ...
    public enum ActivateAudioTrackCommandField {
      TrackID(0),
      AudioOutputIndex(1),
      ;
      private final int id;
    ...
    public enum ActivateTextTrackCommandField {
      TrackID(0),
      ;
      private final int id;
  ...
  public static class AccountLogin implements BaseCluster {
    ...
    public enum LogoutCommandField {
      Node(0),
      ;
      private final int id;
  ...
  public static class ContentControl implements BaseCluster {
    ...
    public enum UpdatePINCommandField {
      OldPIN(0),
      NewPIN(1),
      ;
      private final int id;
    ...
    public enum AddBonusTimeCommandField {
      PINCode(0),
      BonusTime(1),
      ;
      private final int id;
    ...
    public enum SetScreenDailyTimeCommandField {
      ScreenTime(0),
      ;
      private final int id;
    ...
    public enum SetOnDemandRatingThresholdCommandField {
      Rating(0),
      ;
      private final int id;
      ...
      public static SetOnDemandRatingThresholdCommandField value(int id) throws NoSuchFieldError {
        for (SetOnDemandRatingThresholdCommandField field :
            SetOnDemandRatingThresholdCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum SetScheduledContentRatingThresholdCommandField {
      Rating(0),
      ;
      private final int id;
      ...
      public static SetScheduledContentRatingThresholdCommandField value(int id)
          throws NoSuchFieldError {
        for (SetScheduledContentRatingThresholdCommandField field :
            SetScheduledContentRatingThresholdCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
  ...
  public static class ContentAppObserver implements BaseCluster {
    ...
    public enum ContentAppMessageCommandField {
      Data(0),
      EncodingHint(1),
      ;
      private final int id;
  ...
  public static class CommissionerControl implements BaseCluster {
    ...
    public enum RequestCommissioningApprovalCommandField {
      RequestId(0),
      VendorId(1),
      ProductId(2),
      Label(3),
      ...
      public static RequestCommissioningApprovalCommandField value(int id) throws NoSuchFieldError {
        for (RequestCommissioningApprovalCommandField field :
            RequestCommissioningApprovalCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum CommissionNodeCommandField {
      RequestId(0),
  ...
  public static class UnitTesting implements BaseCluster {
    ...
    public enum TestBatchHelperRequestCommandField {
      ...
      public static TestBatchHelperRequestCommandField value(int id) throws NoSuchFieldError {
        for (TestBatchHelperRequestCommandField field :
            TestBatchHelperRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum TestSecondBatchHelperRequestCommandField {
      SleepBeforeResponseTimeMs(0),
      SizeOfResponseBuffer(1),
      FillCharacter(2),
      ;
      ...
      public static TestSecondBatchHelperRequestCommandField value(int id) throws NoSuchFieldError {
        for (TestSecondBatchHelperRequestCommandField field :
            TestSecondBatchHelperRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }
    ...
    public enum StringEchoRequestCommandField {
      Payload(0),
      ;
      private final int id;
    ...
    public enum TestDifferentVendorMeiRequestCommandField {
      Arg1(0),
      ;
      private final int id;
      ...
      public static TestDifferentVendorMeiRequestCommandField value(int id)
          throws NoSuchFieldError {
        for (TestDifferentVendorMeiRequestCommandField field :
            TestDifferentVendorMeiRequestCommandField.values()) {
          if (field.getID() == id) {
            return field;
          }
        }

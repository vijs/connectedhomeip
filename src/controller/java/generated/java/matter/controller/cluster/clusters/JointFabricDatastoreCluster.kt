...
class JointFabricDatastoreCluster(
  ...
  class StatusEntryAttribute(val value: List<JointFabricDatastoreClusterDatastoreStatusEntry>)

  sealed class StatusEntryAttributeSubscriptionState {
    data class Success(val value: List<JointFabricDatastoreClusterDatastoreStatusEntry>) :
  ...
  suspend fun readStatusEntryAttribute(): StatusEntryAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreStatusEntry> =
      buildList<JointFabricDatastoreClusterDatastoreStatusEntry> {
        tlvReader.enterArray(AnonymousTag)
        while (!tlvReader.isEndOfContainer()) {
